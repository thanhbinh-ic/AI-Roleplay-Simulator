...
const CharacterSheetIcon = ({ className = "w-5 h-5 mr-1" }) => (
  ...
  >
    ...
    <path d="M12.75 3H10.5a.75.75 0 0 0-.75.75v3c0 .414.336.75.75.75h3c.414 0 .75-.336.75-.75v-3a.75.75 0 0 0-.75-.75Z" />
    <path d="M12.75 12.75h3.75a.75.75 0 0 0 .75-.75V9.375a.75.75 0 0 0-.75-.75h-3.75a.75.75 0 0 0-.75.75v2.625c0 .414.336.75.75.75Z" />
  </svg>
);
...
const ArrowUpTrayIcon = () => (
  ...
  >
    <path
      fillRule="evenodd"
      d="M11.47 2.47a.75.75 0 0 1 1.06 0l4.5 4.5a.75.75 0 0 1-1.06 1.06l-3.22-3.22V16.5a.75.75 0 0 1-1.5 0V4.81L8.03 8.03a.75.75 0 0 1-1.06-1.06l4.5-4.5ZM3 18.75a.75.75 0 0 1 .75-.75h16.5a.75.75 0 0 1 0 1.5H3.75a.75.75 0 0 1-.75-.75Z"
      clipRule="evenodd"
    />
  </svg>
);
...
const GameSetupScreen = ({
  ...
  <div className="min-h-screen bg-gray-800 text-white p-4 md:p-6 flex flex-col items-center">
    <div className="w-full max-w-3xl bg-gray-700 p-6 md:p-8 rounded-xl shadow-2xl relative">
      ...
      <h2 className="text-3xl md:text-4xl font-bold text-purple-400 mb-8 text-center pt-10 sm:pt-0">
    ...
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center p-4 z-50">
      <div className="bg-gray-800 p-6 rounded-xl shadow-2xl w-full max-w-xl max-h-[85vh] flex flex-col border border-purple-600">
        <h3 className="text-2xl font-bold text-purple-400 mb-4 flex items-center">
          <CharacterSheetIcon /> Thông Tin Nhân Vật & Thế Giới
        </h3>
...
const GameplayScreen = ({
  ...
  <div className="min-h-screen bg-gray-900 text-gray-100 flex flex-col p-2 md:p-4 font-['Arial',_sans-serif]">
    <header className="flex flex-col sm:flex-row justify-between items-center mb-3 gap-2 p-2 bg-gray-800/50 rounded-lg shadow-md">
      <button
        onClick={goHome}
        className="bg-purple-600 hover:bg-purple-700 text-white font-semibold py-2 px-3 rounded-lg shadow-md transition-colors flex items-center self-start sm:self-center text-sm"
      >
        <ArrowLeftStartOnRectangleIcon /> Về Trang Chủ
      </button>
...
const App = () => {
  ...
  const exportGameToJson = () => {
    try {
      ...
      console.log("Exported successfully via Blob");
    } catch (error) {
