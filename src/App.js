...
const App = () => {
  ...
  const testApiKey = async () => {
    ...
    const apiUrl = `https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=${inputApiKey}`;
  ...
  const fetchGenericGeminiText = async (promptText) => {
    ...
    const apiUrl = `https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=${effectiveApiKey}`;
