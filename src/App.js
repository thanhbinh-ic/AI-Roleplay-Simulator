...
const SaveIcon = () => (
  ...
  >
    ...
    <path d="M9 3.75a.75.75 0 0 1 .75.75v4.5a.75.75 0 0 1-1.5 0v-4.5A.75.75 0 0 1 9 3.75Zm6.75 0a.75.75 0 0 1 .75.75v4.5a.75.75 0 0 1-1.5 0v-4.5a.75.75 0 0 1 .75-.75Z" />
  </svg>
);
const CheckIcon = () => (
  <svg
...
const ArrowPathIcon = () => (
  ...
  >
    <path
      fillRule="evenodd"
      d="M4.755 10.059a7.5 7.5 0 0 1 12.548-3.364l1.903 1.903h-4.5a.75.75 0 0 0 0 1.5h6a.75.75 0 0 0 .75-.75V4.5a.75.75 0 0 0-1.5 0v2.72a9 9 0 1 0-10.713 9.926.75.75 0 0 0 1.214-.882A7.474 7.474 0 0 1 5.353 10.5H4.755Z"
      clipRule="evenodd"
    />
  </svg>
);
...
const ArrowLeftStartOnRectangleIcon = () => (
  ...
  >
    <path
      fillRule="evenodd"
      d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25Zm-2.625 6c-.54 0-.828.419-.936.634a1.96 1.96 0 0 0-.189.866c0 .298.012.626.035.95.023.324.075.72.14 1.062.066.34.152.673.253.97.102.296.223.543.358.745.136.201.287.34.45.425.164.086.342.12.524.12.182 0 .36-.034.524-.12a1.32 1.32 0 0 0 .45-.425c.135-.202.256-.449.357-.745.101-.297.187-.63.253-.97.065-.342.117-.738.14-1.062.023-.324.035-.652.035-.95a1.96 1.96 0 0 0-.189-.866c-.108-.215-.396-.634-.936-.634H9.375Z"
      clipRule="evenodd"
    />
  </svg>
);
...
const ExclamationTriangleIcon = ({
  ...
  >
    <path
      fillRule="evenodd"
      d="M9.401 3.003c1.155-2 4.043-2 5.197 0l7.519 13.007c1.155 2-.772 4.5-3.298 4.5H5.18c-2.526 0-4.453-2.5-3.298-4.5L9.4 3.003ZM12 8.25a.75.75 0 0 1 .75.75v3.75a.75.75 0 0 1-1.5 0V9a.75.75 0 0 1 .75-.75Zm0 8.25a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Z"
      clipRule="evenodd"
    />
  </svg>
);
...
const SparklesIcon = ({ className = "w-4 h-4" }) => (
  ...
  >
    <path
      fillRule="evenodd"
      d="M10.868 2.884c-.321-.772-1.415-.772-1.736 0l-1.83 4.401-4.753.39-3.423 3.11a.75.75 0 0 0 .44 1.316l4.861 1.214 1.83 4.401c.321.772 1.415.772 1.736 0l1.83-4.401 4.753-.39 3.423-3.11a.75.75 0 0 0-.44-1.316l-4.861-1.214-1.83-4.401Z"
      clipRule="evenodd"
    />
  </svg>
);
const LightBulbIcon = ({ className = "w-5 h-5 mr-1" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="currentColor"
...
const UserGroupIcon = ({ className = "w-5 h-5 mr-2" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="currentColor"
    className={className}
  >
    <path d="M4.5 6.375a.75.75 0 0 1 .75-.75h2.25a.75.75 0 0 1 0 1.5H5.25a.75.75 0 0 1-.75-.75Z" />
    <path
      fillRule="evenodd"
      d="M5.25 7.5A2.25 2.25 0 0 1 3 5.25v-1.5A2.25 2.25 0 0 1 5.25 1.5h13.5A2.25 2.25 0 0 1 21 3.75v1.5A2.25 2.25 0 0 1 18.75 7.5h-1.5a.75.75 0 0 1 0-1.5h1.5a.75.75 0 0 0 .75-.75v-1.5a.75.75 0 0 0-.75-.75H5.25a.75.75 0 0 0-.75.75v1.5c0 .414.336.75.75.75Zm2.03 4.72a.75.75 0 0 1 1.06 0l.97.97a.75.75 0 1 1-1.06 1.06l-.97-.97a.75.75 0 0 1 0-1.06Zm-2.25 2.25a.75.75 0 0 0 0 1.06l.97.97a.75.75 0 1 0 1.06-1.06l-.97-.97a.75.75 0 0 0-1.06 0Z"
      clipRule="evenodd"
    />
    <path d="M12.75 11.625a.75.75 0 0 0-1.5 0v6.75a.75.75 0 0 0 1.5 0v-6.75Z" />
    <path d="M14.25 12.375a.75.75 0 0 1 .75-.75h2.25a.75.75 0 0 1 0 1.5H15a.75.75 0 0 1-.75-.75Z" />
    <path
      fillRule="evenodd"
      d="M15 13.5A2.25 2.25 0 0 1 12.75 11.25v-1.5A2.25 2.25 0 0 1 15 7.5h3.75A2.25 2.25 0 0 1 21 9.75v1.5A2.25 2.25 0 0 1 18.75 13.5h-1.5a.75.75 0 0 1 0-1.5h1.5a.75.75 0 0 0 .75-.75v-1.5a.75.75 0 0 0-.75-.75H15a.75.75 0 0 0-.75.75v1.5c0 .414.336.75.75.75Zm-2.03 4.72a.75.75 0 0 1 1.06 0l.97.97a.75.75 0 0 1-1.06 1.06l-.97-.97a.75.75 0 0 1 0-1.06Zm-2.25 2.25a.75.75 0 0 0 0 1.06l.97.97a.75.75 0 1 0 1.06-1.06l-.97-.97a.75.75 0 0 0-1.06 0Z"
      clipRule="evenodd"
    />
    <path d="M5.25 12.375a.75.75 0 0 1 .75-.75h2.25a.75.75 0 0 1 0 1.5H6a.75.75 0 0 1-.75-.75Z" />
    <path
      fillRule="evenodd"
      d="M6 13.5A2.25 2.25 0 0 1 3.75 11.25v-1.5A2.25 2.25 0 0 1 6 7.5h3.75A2.25 2.25 0 0 1 12 9.75v1.5A2.25 2.25 0 0 1 9.75 13.5H8.25a.75.75 0 0 1 0-1.5h1.5a.75.75 0 0 0 .75-.75v-1.5a.75.75 0 0 0-.75-.75H6a.75.75 0 0 0-.75.75v1.5c0 .414.336.75.75.75Z"
      clipRule="evenodd"
    />
  </svg>
);
...
const TrashIcon = ({ className = "w-5 h-5" }) => (
  ...
  >
    <path
      fillRule="evenodd"
      d="M8.75 1A2.75 2.75 0 0 0 6 3.75v.443c-.795.077-1.58.177-2.34.297A1.875 1.875 0 0 0 2.05 6.22l.83 9.126A3.375 3.375 0 0 0 6.199 18.75h7.602a3.375 3.375 0 0 0 3.319-3.398l.83-9.126a1.875 1.875 0 0 0-1.61-1.731c-.76-.12-1.546-.22-2.34-.297V3.75A2.75 2.75 0 0 0 11.25 1h-2.5ZM7.5 3.75c0-.69.56-1.25 1.25-1.25h2.5c.69 0 1.25.56 1.25 1.25V4h-5V3.75Z"
      clipRule="evenodd"
    />
  </svg>
);
const BuildingStorefrontIcon = ({ className = "w-5 h-5 mr-2" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="currentColor"
  ...
  >
    ...
    <path d="M6.262 6.072a8.25 8.25 0 0 1 11.477 0 7.5 7.5 0 0 1 0 11.855.75.75 0 0 0 .36.968l1.43 1.072a.75.75 0 0 0 .968-.36 8.25 8.25 0 0 0-11.477 0 .75.75 0 0 0 .968.36l1.43-1.072a.75.75 0 0 0 .36-.968 7.5 7.5 0 0 1 0-11.856Z" />
  </svg>
);
const BackpackIcon = ({ className = "w-5 h-5 mr-1" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="currentColor"
  ...
  >
    <path
      fillRule="evenodd"
      d="M8.25 1.5A2.25 2.25 0 0 0 6 3.75v16.5A2.25 2.25 0 0 0 8.25 22.5h7.5A2.25 2.25 0 0 0 18 20.25V3.75A2.25 2.25 0 0 0 15.75 1.5h-7.5ZM9 3a.75.75 0 0 0 0 1.5h6A.75.75 0 0 0 15 3H9Z"
      clipRule="evenodd"
    />
  </svg>
);
const BoltIcon = ({ className = "w-5 h-5 mr-1" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="currentColor"
...
const HeartIcon = ({ className = "w-5 h-5 mr-1" }) => (
  <svg
    ...
    className={className}
  >
    <path d="M11.645 20.91a.75.75 0 0 1-1.29 0A18.377 18.377 0 0 1 4.5 9.285c0-3.995 3.05-7.285 6.75-7.285 1.74 0 3.341.81 4.5 2.125 1.159-1.315 2.76-2.125 4.5-2.125 3.7 0 6.75 3.29 6.75 7.285 0 3.071-1.703 6.082-5.234 9.335A18.377 18.377 0 0 1 11.645 20.91Z" />
  </svg>
);
const CharacterSheetIcon = ({ className = "w-5 h-5 mr-1" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
    strokeWidth={1.5}
    stroke="currentColor"
    className="w-4 h-4 mr-1.5" // Kích thước nhỏ gọn phù hợp với text-xs
  >
    <path
      strokeLinecap="round"
...
const FaceSmileIcon = ({ className = "w-5 h-5 mr-1" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="currentColor"
...
const BullseyeIcon = ({ className = "w-5 h-5 mr-1 text-red-400" }) => (
  ...
  >
    <path
      fillRule="evenodd"
      d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25ZM12.75 6a.75.75 0 0 0-1.5 0v6c0 .414.336.75.75.75s.75-.336.75-.75V6ZM12 15a.75.75 0 0 1 .75.75v.008c0 .414-.336.75-.75.75s-.75-.336-.75-.75V15.75A.75.75 0 0 1 12 15Z"
      clipRule="evenodd"
    />
  </svg>
);
const HeartCrackIcon = ({ className = "w-5 h-5 mr-1" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="currentColor"
  ...
  >
    ...
    <path d="M12.963 2.317A5.23 5.23 0 0 0 8.25 1.5C5.092 1.5 2.257 4.092 2.257 7.543c0 3.24 2.747 6.721 8.38 12.354l1.008 1.008a.75.75 0 0 0 1.29-.001l6.737-6.737a5.252 5.252 0 0 0 .218-7.963 5.202 5.202 0 0 0-4.196-2.002 5.175 5.175 0 0 0-3.731 1.568l-.001.001Z" />
  </svg>
);
const ShieldCheckIcon = ({ className = "w-5 h-5 mr-1" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="currentColor"
  ...
  >
    <path
      fillRule="evenodd"
      d="M12.75 2.239c.204-.063.419-.063.622 0l8.25 2.526c.07.021.136.05.2.084a1.124 1.124 0 0 1 .602 1.01V12c0 5.084-3.158 9.734-7.752 11.563a.75.75 0 0 1-.642 0C8.658 21.734 5.5 17.084 5.5 12V5.86c0-.39.223-.748.552-.926.068-.036.136-.064.203-.084L12.75 2.24ZM14.25 16.12l7.22-7.22a.75.75 0 0 0-1.06-1.06l-6.69 6.69-2.72-2.72a.75.75 0 0 0-1.06 1.06l3.25 3.25a.75.75 0 0 0 1.06 0Z"
      clipRule="evenodd"
    />
  </svg>
);
const MegaphoneIcon = ({ className = "w-5 h-5 mr-2" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="currentColor"
    className={className}
  >
    <path d="M10.5 1.5H5.25A2.25 2.25 0 0 0 3 3.75v16.5A2.25 2.25 0 0 0 5.25 22.5h13.5A2.25 2.25 0 0 0 21 20.25V10.5A2.25 2.25 0 0 0 18.75 8.25h-3.573L13.5 4.577A2.25 2.25 0 0 0 10.5 1.5ZM5.625 15.75a.75.75 0 0 1 .75-.75h11.25a.75.75 0 0 1 0 1.5H6.375a.75.75 0 0 1-.75-.75Zm0-3a.75.75 0 0 1 .75-.75h11.25a.75.75 0 0 1 0 1.5H6.375a.75.75 0 0 1-.75-.75Zm0-3a.75.75 0 0 1 .75-.75H12a.75.75 0 0 1 0 1.5H6.375a.75.75 0 0 1-.75-.75Z" />
    <path d="M12.75 6a.75.75 0 0 0-1.5 0v1.5h-1.5a.75.75 0 0 0 0 1.5h1.5v1.5a.75.75 0 0 0 1.5 0v-1.5h1.5a.75.75 0 0 0 0-1.5h-1.5V6Z" />
  </svg>
);
const ClipboardDocumentCheckIcon = ({ className = "w-5 h-5 mr-1" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="currentColor"
...
const changelogData = [
  {
    ...
    date: "07/04/2026",
    changes: [
      "QUAN TRỌNG: Khắc phục triệt để lỗi treo ứng dụng khi hệ thống kiểm tra phiên bản lúc khởi động.",
      "THÊM MỚI: Nút 'Kiểm Tra Cập Nhật' tại màn hình chính, cho phép người chơi chủ động đồng bộ hóa với dữ liệu mới nhất từ máy chủ.",
      "CẬP NHẬT HỆ THỐNG: Cơ chế điều hướng thông minh, tự động trỏ tới liên kết tải bản mới nhất.",
      "GIAO DIỆN: Tối ưu hóa Popup thông báo với hiệu ứng làm mờ nền và hoạt ảnh chuyển động mượt mà.",
      "TRẢI NGHIỆM: Tích hợp tham số chống lưu bộ nhớ đệm (Cache-Busting) để đảm bảo thông tin phiên bản luôn được cập nhật tức thì.",
      "Cải thiện khả năng xử lý ngoại lệ khi kết nối API từ xa bị gián đoạn.",
    ],
  },
  {
    ...
    date: "06/04/2026",
    changes: [
      "QUAN TRỌNG: Sửa lỗi xung đột ID khi khởi tạo hành trình mới, đảm bảo file save không bị ghi đè vào ID cũ.",
      "THÊM MỚI: Cơ chế tung xúc xắc (Dice System) minh bạch với 5 mức độ thành công từ Rất Thấp đến Rất Cao.",
      "CẢI TIẾN AI: Hệ thống xác suất thông minh, tự động tính toán tỷ lệ dựa trên Kỹ năng và Trạng thái hiện tại của nhân vật.",
      "TỐI ƯU ĐỘ KHÓ: Cân bằng lại hậu quả thất bại.",
      "GIAO DIỆN: Tối ưu hóa hiển thị danh sách lựa chọn, bổ sung thông tin.",
      "Cải thiện hiệu suất tải dữ liệu từ Firestore và đồng bộ trạng thái Knowledge Base.",
    ],
  },
  {
    version: "2.3 (Cải Tiến AI)",
    date: "05/04/2026",
    changes: [
      "CẢI TIẾN KIẾN TẠO: AI gợi ý thông minh hơn.",
      "THÊM MỚI: Cơ chế Game over, Độ khó Ác Mộng cực kỳ khó, lựa chọn sai phải chịu hậu quả.",
    ],
  },
  {
    version: "2.2 (Cải Tiến & Sửa lỗi)",
    date: "31/03/2026",
    changes: [
      "SỬA LỖI: Các lựa chọn đôi lúc hiển thị sai.",
      "SỬA LỖI: Mất lựa chọn khi lỗi API.",
      "THÊM MỚI: Chức năng lưu nội dung chuyện.",
      "CẢI TIẾN NHIỆM VỤ: Các nhiệm vụ logic và phần thưởng sẽ tác động đến hành trình.",
      "Sửa lỗi hiển thị ở giao diện.",
    ],
  },
  {
    version: "2.1 (Chức Năng & Giao Diện)",
    date: "30/03/2026",
    changes: [
      "THÊM MỚI: Lưu và tải file! Giờ đây có thể lưu tiến độ và chơi trên các thiết bị khác nhau.",
      "THÊM MỚI: Khi vừa tải câu truyện sẽ tự cuộn xuống dưới cùng.",
      "CẢI TIẾN GIAO DIỆN: Điều chỉnh về giao diện và thêm các biểu tượng mới.",
      "Sửa lỗi mất quá trình chơi khi thoát đột ngột.",
      "Sửa các lỗi còn tồn đọng.",
    ],
  },
  {
...
const PLAYER_PERSONALITIES = [
  ...
  "Thích Phiêu Lưu, Không Ngại Mạo Hiểm",
  "Cẩn Thận Từng Chi Tiết, Cầu Toàn",
  "Hào Sảng, Thích Giúp Đỡ Người Khác",
  "Kiên Định, Không Dễ Bỏ Cuộc",
  ...
  <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 p-6">
    ...
    <div className="space-y-4 w-full max-w-md">
      ...
      <button
        ...
        className="w-full flex items-center justify-center bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-bold py-4 px-6 rounded-xl shadow-xl hover:shadow-2xl transition-all transform hover:scale-105 text-lg focus:outline-none focus:ring-4 focus:ring-pink-400 focus:ring-opacity-50"
      >
      ...
      <label className="w-full flex items-center justify-center bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white font-semibold py-3 px-6 rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:scale-105 text-lg cursor-pointer focus:outline-none focus:ring-4 focus:ring-indigo-400 focus:ring-opacity-50">
        <ArrowUpTrayIcon />
        <span>Tải Game Từ Tệp (.json)</span>
        <input
          type="file"
          accept=".json"
          className="hidden"
          onChange={props.importGameFromJson}
        />
      </label>
      <button
      ...
      <button
        onClick={() => {
          props.setInputApiKey(props.apiMode === "userKey" ? props.apiKey : "");
          props.setShowApiModal(true);
        }}
      ...
      <button
        onClick={() => {
          props.setShowDonationModal(true);
        }}
        className="w-full flex items-center justify-center bg-rose-600 hover:bg-rose-500 text-white font-semibold py-3 px-6 rounded-xl shadow-md hover:shadow-lg transition-all transform hover:scale-105 text-lg focus:outline-none focus:ring-4 focus:ring-rose-500 focus:ring-opacity-50"
      >
        <HeartDonateIcon /> Ủng Hộ Tác Giả
      </button>
    </div>
    <p className={`mt-6 text-sm text-center ${props.apiKeyStatus.color}`}>
      {props.apiKeyStatus.status}: {props.apiKeyStatus.message}
    </p>
    <p className="mt-1 text-xs text-gray-400">
      Một sản phẩm của:{" "}
      <a
        href="https://www.facebook.com/binhxy/"
        target="_blank"
    ...
    {props.userId && (
      <p className="mt-1 text-xs text-gray-400">UserID: {props.userId}</p>
    )}
  </div>
);
...
const ApiSetupModal = ({
  ...
  const handleUseDefaultGemini = () => {
    ...
    setModalMessage({
      show: true,
      title: "Chế Độ AI Mặc Định",
      content:
        "Đã chuyển sang sử dụng Gemini AI mặc định. Ngươi không cần cung cấp API Key.",
      type: "success",
    });
  };
  return (
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center p-4 z-50">
      <div className="bg-gray-800 p-8 rounded-xl shadow-2xl w-full max-w-lg transform transition-all">
        ...
        >
          <SparklesIcon className="w-5 h-5 mr-2" /> Sử Dụng Gemini AI Mặc Định
          (Đề xuất)
        </button>
        ...
        <div>
          <label
            ...
            className={`block text-sm font-medium mb-1 ${apiMode === "userKey" ? "text-gray-300" : "text-gray-500"}`}
          >
        ...
        {apiMode === "userKey" && (
          <>
            <div className={`my-3 text-sm ${apiKeyStatus.color}`}>
              {apiKeyStatus.status}: {apiKeyStatus.message}
            </div>
        ...
        {apiMode === "defaultGemini" && (
          <div className="my-3 text-sm text-sky-400">
            Đang sử dụng Gemini AI mặc định. Không cần lưu hay kiểm tra API Key.
          </div>
        )}
        <button
          onClick={() => {
            ...
            if (apiMode === "userKey" && !apiKey) {
              setApiKeyStatus({
                status: "Chưa cấu hình",
                message: "Vui lòng nhập API Key của bạn.",
                color: "text-yellow-500",
              });
            } else if (apiMode === "userKey" && apiKey) {
              setApiKeyStatus({
                status: "Đã kết nối",
                message: "API Key của bạn đã được tải.",
...
const GameSetupScreen = ({
  ...
  <div className="min-h-screen bg-gray-800 text-white p-4 md:p-6 flex flex-col items-center">
    <div className="w-full max-w-3xl bg-gray-700 p-6 md:p-8 rounded-xl shadow-2xl relative">
      <button
        onClick={goHome}
        className="absolute top-4 left-4 text-purple-400 hover:text-purple-300 text-sm flex items-center bg-gray-600 hover:bg-gray-500 p-2 rounded-lg shadow transition-colors"
      >
        <ArrowLeftStartOnRectangleIcon /> Về Trang Chủ
      </button>
      <h2 className="text-3xl md:text-4xl font-bold text-purple-400 mb-8 text-center pt-10">
        Kiến Tạo Thế Giới Của Ngươi
      </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 mb-6">
        ...
        <div className="space-y-6">
          <fieldset className="border border-gray-600 p-4 rounded-lg">
            <legend className="text-xl font-semibold text-pink-400 px-2">
              Bối Cảnh Truyện
            </legend>
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    placeholder="VD: Tiên hiệp, Huyền huyễn, Đô thị dị năng..."
                    className="w-full p-3 bg-gray-600 border border-gray-500 rounded-lg focus:ring-pink-500 focus:border-pink-500"
                  />
                  <button
                    onClick={() => handleFetchSuggestions("theme")}
                    disabled={
                      isFetchingSuggestions ||
                      (apiMode === "userKey" && !apiKey)
                    }
                    className="p-3 bg-pink-600 hover:bg-pink-700 rounded-lg disabled:bg-gray-500"
                    title="✨ Gợi ý Chủ đề"
                  >
                    {isFetchingSuggestions ? (
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    onChange={handleInputChange}
                    placeholder="VD: Đại Lục Phong Vân, Tinh Không Vô Tận..."
                    className="w-full p-3 bg-gray-600 border border-gray-500 rounded-lg focus:ring-pink-500 focus:border-pink-500"
                  />
                  <button
                    onClick={() => handleFetchSuggestions("setting")}
                    disabled={
                      isFetchingSuggestions ||
                      (apiMode === "userKey" && !apiKey)
                    }
          ...
          <fieldset className="border border-gray-600 p-4 rounded-lg">
            <legend className="text-xl font-semibold text-teal-400 px-2">
              Độ Khó & Nội Dung
            </legend>
            <div className="mt-2 space-y-4">
              <div>
                ...
                >
                  <option value="Dễ">
                    Dễ - Dành cho người mới, ít thử thách
                  </option>
                  <option value="Thường">
                  ...
                  <option value="Ác Mộng">
                    Ác Mộng - Cực kỳ khó, không khoan nhượng
                  </option>
                  <option value="Tuỳ Chỉnh AI">
                    Tuỳ Chỉnh AI - Để AI mô tả độ khó
                  </option>
                </select>
              </div>
              {(gameSettings.difficulty === "Tuỳ Chỉnh AI" ||
                gameSettings.difficultyDescription) && (
                <div>
                  <label
                    htmlFor="difficultyDescription"
                    className="block text-lg font-medium text-gray-300 mb-1"
                  >
                    Mô Tả Độ Khó (AI hoặc Tự Điền):
                  </label>
                  <div className="flex items-center gap-2">
                    <textarea
                      name="difficultyDescription"
                      id="difficultyDescription"
                      value={gameSettings.difficultyDescription}
                      onChange={handleInputChange}
                      rows="2"
                      placeholder="AI sẽ mô tả độ khó ở đây..."
                      className="w-full p-3 bg-gray-600 border border-gray-500 rounded-lg focus:ring-teal-500 focus:border-teal-500"
                    />
                    {gameSettings.difficulty === "Tuỳ Chỉnh AI" && (
                      <button
                        onClick={handleGenerateDifficultyDescription}
                        disabled={
                          isGeneratingDifficultyDesc ||
                          (apiMode === "userKey" && !apiKey)
                        }
                        className="p-3 bg-teal-600 hover:bg-teal-700 rounded-lg disabled:bg-gray-500 self-start"
                        title="✨ AI Tạo Mô Tả Độ Khó"
                      >
                        {isGeneratingDifficultyDesc ? (
                          <div className="w-5 h-5 border-2 border-t-transparent border-white rounded-full animate-spin"></div>
                        ) : (
              ...
              <div className="flex items-center mt-3">
                <input
                  ...
                  name="allowNsfw"
                  id="allowNsfw"
                  checked={gameSettings.allowNsfw}
                  onChange={handleInputChange}
              ...
              <p className="text-xs text-gray-400 italic">
                Khi tick chọn, AI sẽ được khuyến khích tạo nội dung khiêu dâm,
                bạo lực cực đoan một cách chi tiết.
              </p>
            </div>
          </fieldset>
        </div>
        ...
        <div className="space-y-6">
          <fieldset className="border border-gray-600 p-4 rounded-lg">
            <legend className="text-xl font-semibold text-sky-400 px-2">
              Nhân Vật Chính
            </legend>
            <div className="mt-2 space-y-4">
              <div>
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    name="characterName"
                    id="characterName"
                    value={gameSettings.characterName}
                    onChange={handleInputChange}
                    placeholder="VD: Diệp Phàm, Hàn Lập, Lâm Động..."
                  ...
                  <button
                    ...
                    className="p-3 bg-sky-600 hover:bg-sky-700 rounded-lg disabled:bg-gray-500"
              ...
              <div>
                ...
                <select
                  ...
                  value={gameSettings.characterPersonality}
                  onChange={handleInputChange}
                  className="w-full p-3 bg-gray-600 border border-gray-500 rounded-lg focus:ring-sky-500 focus:border-sky-500"
                >
              ...
              <div>
                ...
                <select
                  ...
                  id="characterGender"
                  value={gameSettings.characterGender}
                  onChange={handleInputChange}
                  className="w-full p-3 bg-gray-600 border border-gray-500 rounded-lg focus:ring-sky-500 focus:border-sky-500"
                >
                  <option value="Không xác định">
                    Không xác định / Để AI quyết định
                  </option>
              ...
              <div>
                <label
                  ...
                  className="block text-lg font-medium text-gray-300 mb-1"
                >
                  Sơ Lược Tiểu Sử/Đặc Điểm (2-3 câu):
                </label>
                <div className="flex items-center gap-2">
                  <textarea
                    name="characterBackstory"
                    id="characterBackstory"
                    value={gameSettings.characterBackstory}
                    onChange={handleInputChange}
                    rows="3"
                    placeholder="VD: Một phế vật mang trong mình huyết mạch thượng cổ, một thiếu nữ tài năng bị vị hôn phu từ hôn..."
                    className="w-full p-3 bg-gray-600 border border-gray-500 rounded-lg focus:ring-sky-500 focus:border-sky-500"
                  ></textarea>
                  <button
                    onClick={handleGenerateBackstory}
                    disabled={
                      isGeneratingContent || (apiMode === "userKey" && !apiKey)
                    }
                    className="p-3 bg-sky-600 hover:bg-sky-700 rounded-lg disabled:bg-gray-500 self-start"
                    title="✨ Tạo Tiểu sử"
                  >
                    {isGeneratingContent ? (
                      <div className="w-5 h-5 border-2 border-t-transparent border-white rounded-full animate-spin"></div>
              ...
              <div>
                <label
                  htmlFor="preferredInitialSkill"
                  className="block text-lg font-medium text-gray-300 mb-1"
                >
                  Kỹ Năng Khởi Đầu Mong Muốn (Tùy chọn):
                </label>
                <div className="flex items-center gap-2">
                  <input
                    type="text"
                    name="preferredInitialSkill"
                    id="preferredInitialSkill"
                    value={gameSettings.preferredInitialSkill}
                    onChange={handleInputChange}
                    placeholder="VD: Thuật ẩn thân, Kiếm pháp cơ bản..."
                    className="w-full p-3 bg-gray-600 border border-gray-500 rounded-lg focus:ring-sky-500 focus:border-sky-500"
                  />
                  <button
                    onClick={handleGenerateInitialSkill}
                    disabled={
                      isGeneratingInitialSkill ||
                      (apiMode === "userKey" && !apiKey)
                    }
                ...
                <p className="text-xs text-gray-400 mt-1 italic">
                  Gợi ý cho AI về loại kỹ năng ngươi muốn bắt đầu. AI sẽ quyết
                  định kỹ năng cụ thể.
                </p>
              </div>
            </div>
          ...
          <fieldset className="border border-red-500/70 p-4 rounded-lg bg-gray-700/20">
            <legend className="text-xl font-semibold text-red-400 px-2 flex items-center">
              <BullseyeIcon /> Mục Tiêu/Động Lực Nhân Vật
            </legend>
            <div className="mt-3 space-y-3">
              <div className="flex items-center">
                ...
                />
                <label
                  htmlFor="useCharacterGoal"
                  className="ml-2 text-sm font-medium text-gray-300"
                >
                  Thêm Mục Tiêu/Động Lực Cho Nhân Vật
                </label>
              </div>
              {gameSettings.useCharacterGoal && (
                <div>
                  <label
                    htmlFor="characterGoal"
                    className="block text-lg font-medium text-gray-300 mb-1"
                  >
                    Mục Tiêu/Động Lực:
                  </label>
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      disabled={
                        isGeneratingGoal || (apiMode === "userKey" && !apiKey)
                      }
                  ...
                  <p className="text-xs text-gray-400 mt-1 italic">
                    Mục tiêu này sẽ ảnh hưởng đến suy nghĩ và hành động của nhân
                    vật trong game.
                  </p>
                </div>
              )}
      ...
      <fieldset className="border-2 border-lime-600 p-4 rounded-lg mb-6 bg-gray-700/30">
        <legend className="text-xl font-semibold text-lime-300 px-2 flex items-center">
          <BuildingStorefrontIcon className="w-5 h-5 mr-1 text-lime-400" /> Kiến
          Tạo Thế Giới Ban Đầu (Tùy chọn)
        </legend>
        <div className="mt-3 space-y-4">
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-2">
                ...
                <div className="md:col-span-2">
                  <label
                    htmlFor={`elementPersonality-${index}`}
                    className="block text-sm font-medium text-gray-300 mb-1"
                  >
                    Tính Cách (Nếu là NPC - AI sẽ tự quyết nếu bỏ trống):
                  </label>
                  <input
                    type="text"
                ...
                <div className="md:col-span-2">
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <button
                      onClick={() =>
                        handleGenerateInitialElementDescription(index)
                      }
                      disabled={
                        isGeneratingInitialElementDesc[element.id] ||
                        !element.name ||
                        (apiMode === "userKey" && !apiKey)
                      }
          ...
          >
            <PlusIcon className="w-5 h-5 mr-1" /> Thêm Thực Thể Ban Đầu
          </button>
        </div>
      </fieldset>
...
const CharacterInfoModal = ({
  ...
  const getStatusIcon = (statusType) => {
    switch (statusType?.toLowerCase()) {
      case "buff":
        return (
          <ShieldCheckIcon className="text-green-400 w-4 h-4 inline-block mr-1" />
        );
      case "debuff":
        return (
          <HeartCrackIcon className="text-red-400 w-4 h-4 inline-block mr-1" />
        );
      case "injury":
        return (
          <ExclamationTriangleIcon className="text-yellow-500 w-4 h-4 inline-block mr-1" />
        );
      default:
        return (
          <InformationCircleIcon className="text-blue-400 w-4 h-4 inline-block mr-1" />
        );
    }
  };
  ...
  const renderSection = (
    ...
    if (!items || items.length === 0)
      return (
        <div className="mb-4">
          <h4
            className={`text-lg font-semibold ${itemColor} mb-1 flex items-center`}
          >
    ...
    return (
      <div className="mb-4">
        <h4
          className={`text-lg font-semibold ${itemColor} mb-2 flex items-center`}
        >
          {icon && <span className="mr-1.5">{icon}</span>}
          {title}
        </h4>
    ...
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center p-4 z-50">
      <div className="bg-gray-800 p-6 rounded-xl shadow-2xl w-full max-w-xl max-h-[85vh] flex flex-col border border-purple-600">
        <h3 className="text-2xl font-bold text-purple-400 mb-4 flex items-center">
          Thông Tin Nhân Vật & Thế Giới
        </h3>
        <div className="overflow-y-auto flex-grow pr-2 scrollbar-thin scrollbar-thumb-purple-500 scrollbar-track-gray-700">
          <div className="mb-4">
            <h4 className="text-lg font-semibold text-amber-400 mb-1 flex items-center">
              <UserCircleIcon /> Nhân Vật Chính
            </h4>
            {characterName && (
              <p className="text-gray-300 text-sm pl-2">Tên: {characterName}</p>
            )}
            <p className="text-gray-300 text-sm pl-2">
              Tính cách: {characterPersonality || "Chưa xác định"}
            </p>
          </div>

          {renderSection(
            "Trạng Thái Hiện Tại",
            knowledge.playerStatus,
            <InformationCircleIcon className="text-indigo-400" />,
            "text-indigo-400",
            (item, index, color) => (
              <li
                key={`status-${index}`}
                className="text-gray-300 p-1.5 bg-gray-700/50 rounded-md"
              >
                <strong className={color}>
                  {getStatusIcon(item.type)}{" "}
                  {item.name || "Trạng thái không tên"}
                </strong>
                ...
                <div className="text-xs text-gray-400 ml-3">
                  ...
                  {item.cureConditions && (
                    <span>Điều kiện hóa giải: {item.cureConditions}. </span>
                  )}
          ...
          {renderSection(
            "Nhật Ký Nhiệm Vụ",
            knowledge.quests,
            <ClipboardDocumentCheckIcon className="text-yellow-400" />,
            "text-yellow-400",
            (quest, index) => (
              <li
                key={`quest-${index}`}
                className={`text-gray-200 p-2 bg-gray-700/60 rounded-md border-l-4 ${quest.status === "completed" ? "border-green-500" : quest.status === "failed" ? "border-red-500" : "border-yellow-500"}`}
              >
                <div className="flex justify-between items-start">
                  <strong
                    className={`font-semibold ${getQuestStatusColor(quest.status)}`}
                  >
                    {quest.title || "Nhiệm vụ không tên"}
                  </strong>
                  <span
          ...
          {renderSection(
            "Balo Đồ",
            knowledge.inventory,
            <BackpackIcon className="text-orange-400" />,
            "text-orange-400",
            (item, index, color) => (
              <li key={`inventory-${index}`} className="text-gray-300">
                <strong className={color}>
                  {item.Name || "Vật phẩm không tên"}
                </strong>
                : {item.Description || "Không có mô tả."}
          ...
          {renderSection(
            ...
            (item, index, color) => (
              <li key={`relation-${index}`} className="text-gray-300">
                <strong className={color}>{item.NPC || "NPC không tên"}</strong>
                : {item.Standing || "Chưa rõ"}
                {item.Reason && (
          ...
          {renderSection(
            ...
            <UserGroupIcon className="text-lime-400" />,
            "text-lime-400",
            (item, index, color) => (
...
const QuickLoreModal = ({ loreItem, show, onClose }) => {
  ...
  let icon = (
    <InformationCircleIcon className="w-5 h-5 mr-2 text-cyan-400 mt-1" />
  );
  const category = loreItem.category?.toLowerCase();

  if (category === "npcs") icon = <UserCircleIcon />;
  else if (category === "items" || category === "inventory")
    icon = <SparklesIcon className="w-5 h-5 mr-2 text-yellow-400 mt-1" />;
  else if (category === "companions")
    icon = <UserGroupIcon className="w-5 h-5 mr-2 text-lime-400 mt-1" />;
  else if (category === "playerskills")
    icon = <BoltIcon className="w-5 h-5 mr-2 text-yellow-400 mt-1" />;
  else if (category === "relationships")
    icon = <HeartIcon className="w-5 h-5 mr-2 text-pink-400 mt-1" />;
  else if (category === "quests")
    icon = (
      <ClipboardDocumentCheckIcon className="w-5 h-5 mr-2 text-yellow-400 mt-1" />
    );
  else if (category === "playerstatus") {
    switch (loreItem.type?.toLowerCase()) {
      case "buff":
        icon = <ShieldCheckIcon className="text-green-400 w-5 h-5 mr-2 mt-1" />;
        break;
      case "debuff":
        icon = <HeartCrackIcon className="text-red-400 w-5 h-5 mr-2 mt-1" />;
        break;
      case "injury":
        icon = (
          <ExclamationTriangleIcon className="text-yellow-500 w-5 h-5 mr-2 mt-1" />
        );
        break;
      default:
        icon = (
          <InformationCircleIcon className="text-blue-400 w-5 h-5 mr-2 mt-1" />
        );
        break;
    }
  }
  ...
  return (
    <div
      className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center p-4 z-[80]"
      onClick={onClose}
    >
      <div
        className="bg-gray-700 p-5 rounded-lg shadow-xl w-full max-w-sm border border-cyan-700"
      ...
      >
        ...
        {loreItem.Personality && (
          <p className="text-xs text-gray-300 mt-1">
            <strong>Tính cách:</strong> {loreItem.Personality}
          </p>
        )}
        {loreItem.Stats && (
          <p className="text-xs text-gray-300 mt-1">
            <strong>Chỉ số:</strong> {loreItem.Stats}
          </p>
        )}
        {loreItem.Type && !loreItem.type && (
          <p className="text-xs text-gray-300 mt-1">
            <strong>Loại (Lore):</strong> {loreItem.Type}
          </p>
        )}
        {loreItem.type && (
          <p className="text-xs text-gray-300 mt-1">
            <strong>Loại (Trạng thái):</strong> {loreItem.type}
          </p>
        )}
        {loreItem.duration && (
          <p className="text-xs text-gray-300 mt-1">
            <strong>Thời gian:</strong> {loreItem.duration}
          </p>
        )}
        {loreItem.effects && (
          <p className="text-xs text-gray-300 mt-1">
            <strong>Ảnh hưởng:</strong> {loreItem.effects}
          </p>
        )}
        {loreItem.cureConditions && (
          <p className="text-xs text-gray-300 mt-1">
            <strong>Điều kiện hóa giải:</strong> {loreItem.cureConditions}
          </p>
        )}
        {loreItem.source && (
          <p className="text-xs text-gray-300 mt-1">
            <strong>Nguồn:</strong> {loreItem.source}
          </p>
        )}
        {loreItem.Reason && (
          <p className="text-xs text-gray-300 mt-1">
            <strong>Lý do (Quan hệ):</strong> {loreItem.Reason}
          </p>
        )}
        {loreItem.Equippable !== undefined && (
          <p className="text-xs text-gray-300 mt-1">
            <strong>Có thể trang bị:</strong>{" "}
            {loreItem.Equippable ? "Có" : "Không"}
          </p>
        )}
        {loreItem.Usable !== undefined && (
          <p className="text-xs text-gray-300 mt-1">
            <strong>Có thể sử dụng:</strong> {loreItem.Usable ? "Có" : "Không"}
          </p>
        )}
        {loreItem.Consumable !== undefined && (
          <p className="text-xs text-gray-300 mt-1">
            <strong>Tiêu hao khi dùng:</strong>{" "}
            {loreItem.Consumable ? "Có" : "Không"}
          </p>
        )}
        {typeof loreItem.Uses === "number" && (
          <p className="text-xs text-gray-300 mt-1">
            <strong>Số lần dùng còn lại:</strong> {loreItem.Uses}
          </p>
        )}
        ...
        {category === "quests" && (
          <>
            {loreItem.status && (
              <p className="text-xs text-gray-300 mt-1">
                <strong>Trạng thái NV:</strong>{" "}
                {loreItem.status === "active"
                  ? "Đang làm"
                  : loreItem.status === "completed"
                    ? "Hoàn thành"
                    : "Thất bại"}
              </p>
            )}
            ...
            {loreItem.giver && (
              <p className="text-xs text-gray-300 mt-1">
                <strong>Người giao:</strong> {loreItem.giver}
              </p>
            )}
            {loreItem.reward && (
              <p className="text-xs text-gray-300 mt-1">
                <strong>Phần thưởng:</strong> {loreItem.reward}
              </p>
            )}
          </>
        )}
    ...
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center p-4 z-[90]">
      <div className="bg-gray-700 p-6 rounded-xl shadow-2xl w-full max-w-md border border-purple-700">
        <h3 className="text-xl font-semibold text-purple-400 mb-4 flex items-center">
          <LightBulbIcon className="w-10 h-10 mr-1 text-purple-400" /> Gợi Ý
          Hành Động
        </h3>
        {isLoading ? (
          ...
          <p className="text-gray-400 text-center py-4">
            Không có gợi ý nào được tạo ra lúc này.
          </p>
        )}
        <button
          onClick={onClose}
...
const GameplayScreen = ({
  ...
  <div className="min-h-screen bg-gray-900 text-gray-100 flex flex-col p-2 md:p-4 font-['Arial',_sans-serif]">
    <header className="flex flex-col sm:flex-row justify-between items-center mb-3 gap-2 p-2 bg-gray-800/50 rounded-lg shadow-md">
      <button
        onClick={goHome}
        className="bg-purple-600 hover:bg-purple-700 text-white font-semibold py-2 px-3 rounded-lg shadow-md transition-colors flex items-center self-start sm:self-center text-xs"
      >
        <ArrowLeftStartOnRectangleIcon /> Về Trang Chủ
      </button>
      <div className="text-center flex-1 mx-2 order-first sm:order-none max-w-md sm:max-w-full">
        <h1
          ...
          title={gameSettings.theme || "Cuộc Phiêu Lưu"}
        >
          {gameSettings.theme || "Cuộc Phiêu Lưu"}
        </h1>
        {gameSettings.characterPersonality && (
          <p
            className="text-xs text-sky-300 flex items-center justify-center mt-0.5"
            title={`Tính cách: ${gameSettings.characterPersonality}`}
          >
            <FaceSmileIcon className="w-4 h-4 mr-1 text-sky-400 flex-shrink-0" />
            <span className="leading-tight">
              Tính cách: {gameSettings.characterPersonality}
            </span>
          </p>
        )}
        {gameSettings.useCharacterGoal && gameSettings.characterGoal && (
          <div
            className="text-xs text-red-300 flex items-start justify-center text-center mt-0.5"
            title={`Mục tiêu: ${gameSettings.characterGoal}`}
          >
            <BullseyeIcon className="w-4 h-4 mr-1 text-red-400 flex-shrink-0 mt-px" />
            <span className="ml-1 leading-tight">
              Mục tiêu: {gameSettings.characterGoal}
            </span>
          </div>
        )}
      </div>
    ...
    {knowledgeBase.playerStatus && knowledgeBase.playerStatus.length > 0 && (
      <div className="bg-gray-750 p-3 rounded-xl shadow-lg mb-3 border border-indigo-700/50">
        <h4 className="text-md font-semibold text-indigo-400 mb-1.5 flex items-center">
          <InformationCircleIcon className="text-indigo-400 w-5 h-5 mr-1.5" />{" "}
          Trạng Thái Hiện Tại
        </h4>
        <div className="flex flex-wrap gap-2 text-xs">
          {knowledgeBase.playerStatus.map((status, index) => {
            ...
            switch (status.type?.toLowerCase()) {
              case "buff":
                icon = <ShieldCheckIcon className="text-green-400" />;
                textColor = "text-green-300";
                break;
              case "debuff":
                icon = <HeartCrackIcon className="text-red-400" />;
              ...
              case "injury":
                ...
                break;
              default:
                icon = <InformationCircleIcon className="text-blue-400" />;
            ...
            return (
              <div
                key={index}
                className={`flex items-center bg-gray-700 p-1.5 rounded-md shadow ${textColor}`}
                title={`${status.description} (Ảnh hưởng: ${status.effects || "Không rõ"}) (Nguồn: ${status.source || "Không rõ"}) (Thời gian: ${status.duration || "Không rõ"})`}
              >
    ...
    {knowledgeBase.quests &&
      knowledgeBase.quests.filter((q) => q.status === "active").length > 0 && (
            ...
            {knowledgeBase.quests
              ...
              .map((quest, index) => (
                <div
                  ...
                  onClick={() => setShowCharacterInfoModal(true)}
                >
                  <ClipboardDocumentCheckIcon className="w-4 h-4 mr-1 text-yellow-300" />{" "}
                  {quest.title}
                </div>
              ))}
          </div>
    ...
    {knowledgeBase.companions && knowledgeBase.companions.length > 0 && (
      <div className="bg-gray-750 p-3 rounded-xl shadow-lg mb-4 border border-lime-700/50">
        <h4 className="text-md font-semibold text-lime-400 mb-2 flex items-center">
          <UserGroupIcon className="w-4 h-4 mr-1 text-lime-400" /> Đồng Hành
        </h4>
    ...
    <div
      className="flex-grow bg-gray-800 p-3 md:p-5 rounded-xl shadow-2xl overflow-y-auto mb-3 scrollbar-thin scrollbar-thumb-purple-600 scrollbar-track-gray-700"
    ...
    >
      ...
      {storyHistory.map((item, index) => (
        <div
          key={index}
          className={`story-item mb-3 p-3 rounded-lg shadow-sm
                  ${
                    item.type === "story"
                      ? "bg-gray-700/80"
                      : item.type === "user_choice"
                        ? "bg-blue-900/70 text-blue-200 ring-1 ring-blue-700"
                        : item.type === "user_custom_action"
                          ? "bg-indigo-900/70 text-indigo-200 ring-1 ring-indigo-700"
                          : "bg-yellow-800/70 text-yellow-200 ring-1 ring-yellow-700"
                  }`}
        >
          {item.type === "user_choice" && (
            <p className="font-semibold text-blue-300">Ngươi đã chọn:</p>
          )}
          {item.type === "user_custom_action" && (
          ...
          {item.type === "system" && (
            <p className="font-semibold text-yellow-300">Thông báo hệ thống:</p>
          )}
    ...
    {!(isLoading) && (
      <div className="bg-gray-800 p-3 md:p-5 rounded-xl shadow-xl mt-auto">
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                onKeyPress={(e) =>
                  e.key === "Enter" && handleCustomAction(customActionInput)
                }
              />
              <button
        ...
        {gameOver.isDead && (
          <div className="mt-8 p-6 bg-red-900/20 border border-red-500/50 rounded-xl text-center">
            <h2 className="text-2xl font-bold text-red-500 mb-2">KẾT THÚC</h2>
            <p className="text-gray-300 mb-4">
              {gameOver.reason || "Nhân vật của bạn đã tử trận."}
            </p>
            <button
    ...
    <div className="bg-gray-800 p-6 rounded-xl shadow-2xl w-full max-w-2xl max-h-[85vh] flex flex-col border border-blue-600">
      ...
      {savedGames.length === 0 ? (
        <p className="text-gray-400 text-center py-6">
          Ngươi chưa có cuộc phiêu lưu nào được lưu lại.
        </p>
      ) : (
        <div className="overflow-y-auto space-y-3 pr-2 scrollbar-thin scrollbar-thumb-blue-500 scrollbar-track-gray-700">
          {savedGames.map((game) => (
            <div
              key={game.id}
              className="bg-gray-700 p-4 rounded-lg hover:bg-gray-600/80 transition-colors shadow-md hover:shadow-lg"
            >
              <h3
                className="text-lg font-semibold text-green-400 truncate"
                title={game.settings?.theme}
              >
                {game.settings?.theme || "Game Chưa Có Tên"}
              </h3>
              <p className="text-sm text-gray-300">
                Nhân vật: {game.settings?.characterName || "N/A"} (Tính cách:{" "}
                {game.settings?.characterPersonality || "Chưa rõ"})
              </p>
              {game.settings?.useCharacterGoal &&
                game.settings?.characterGoal && (
                  <p
                    className="text-xs text-red-300 truncate"
                    title={`Mục tiêu: ${game.settings.characterGoal}`}
                  >
                    Mục tiêu: {game.settings.characterGoal.substring(0, 70)}
                    {game.settings.characterGoal.length > 70 ? "..." : ""}
                  </p>
                )}
              <p className="text-xs text-gray-400">
                Lần cập nhật cuối:{" "}
                {game.updatedAt
                  ? new Date(game.updatedAt.toDate()).toLocaleString("vi-VN")
                  : "N/A"}
              </p>
              <p className="text-xs text-gray-400">
                Độ khó: {game.settings?.difficulty || "Không rõ"}{" "}
                {game.settings?.difficultyDescription
                  ? `(${game.settings.difficultyDescription.substring(0, 30)}...)`
                  : ""}
              </p>
                      ...
                      onConfirm: async () => {
                        try {
                          await deleteDoc(
                            doc(
                              db,
                              `artifacts/${appId}/users/${userId}/games`,
                              game.id,
                            ),
                          );
                          ...
                          setModalMessage({
                            show: true,
                            title: "Đã Xóa",
                            content: `Game "${game.settings?.theme || game.id}" đã được xóa.`,
                            type: "success",
                          });
                        } catch (error) {
                          ...
                          setModalMessage({
                            show: true,
                            title: "Lỗi Xóa Game",
                            content: `Không thể xóa game: ${error.message}`,
                            type: "error",
                          });
                        }
                      },
...
const ConfirmationModal = ({
  ...
  cancelText = "Hủy",
  setConfirmationModal: localSetConfirmationModal,
}) => {
  if (!show) return null;
  return (
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center p-4 z-[100]">
      <div className="bg-gray-800 p-6 rounded-xl shadow-2xl w-full max-w-md border border-yellow-700">
        ...
        <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
          <button
            onClick={() => {
              onConfirm();
              localSetConfirmationModal((prev) => ({ ...prev, show: false }));
            }}
    ...
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center p-4 z-[70]">
      <div className="bg-gray-800 p-6 rounded-xl shadow-2xl w-full max-w-md border border-pink-700">
        ...
        {isLoading ? (
          ...
          <p className="text-gray-400 text-center py-4">
            Không có gợi ý nào được tạo ra. Hãy thử lại hoặc tự sáng tạo!
          </p>
        )}
        <button
          onClick={onClose}
...
const App = () => {
  ...
  const [gameOver, setGameOver] = useState({ isDead: false, reason: "" });
  const [isGeneratingContent, setIsGeneratingContent] = useState(false);
  const [isGeneratingDifficultyDesc, setIsGeneratingDifficultyDesc] =
    useState(false);
  const [isGeneratingInitialElementDesc, setIsGeneratingInitialElementDesc] =
    useState({});
  const [isGeneratingGoal, setIsGeneratingGoal] = useState(false);
  const [isGeneratingSuggestedActions, setIsGeneratingSuggestedActions] =
    useState(false);
  const [suggestedActionsList, setSuggestedActionsList] = useState([]);
  const [showSuggestedActionsModal, setShowSuggestedActionsModal] =
    useState(false);
  const [isGeneratingCharacterName, setIsGeneratingCharacterName] =
    useState(false);
  const [isGeneratingInitialSkill, setIsGeneratingInitialSkill] =
    useState(false);
  ...
  const openQuickLoreModal = useCallback(
    (category, nameOrTitle) => {
      let item = null;
      const categoryKey = category.toLowerCase();
      if (knowledgeBase && knowledgeBase[categoryKey]) {
        item = knowledgeBase[categoryKey].find(
          (i) =>
            (i.Name &&
              i.Name.trim().toLowerCase() ===
                nameOrTitle.trim().toLowerCase()) ||
            (i.NPC &&
              i.NPC.trim().toLowerCase() ===
                nameOrTitle.trim().toLowerCase()) ||
            (i.name &&
              i.name.trim().toLowerCase() ===
                nameOrTitle.trim().toLowerCase()) ||
      ...
      if (item) {
        ...
        console.warn(
          `Quick lore not found for category '${categoryKey}', name/title '${nameOrTitle}'.`,
        );
        setModalMessage({
          show: true,
          title: "Không Tìm Thấy",
          content: `Không tìm thấy thông tin chi tiết cho '${nameOrTitle}'.`,
          type: "info",
        });
      }
    },
      ...
      const unsubscribe = onSnapshot(
        ...
        (error) => {
          ...
          setModalMessage({
            show: true,
            title: "Lỗi Tải Game",
            content: `Không thể tải danh sách game đã lưu: ${error.message}`,
            type: "error",
          });
        },
      );
  ...
  const removeInitialWorldElement = (id) => {
    setGameSettings((prev) => ({
      ...prev,
      initialWorldElements: prev.initialWorldElements.filter(
        (el) => el.id !== id,
      ),
    }));
  };
  ...
  const handleGenerateInitialElementDescription = async (index) => {
    if (apiMode === "userKey" && !apiKey) {
      setModalMessage({
        show: true,
        title: "Thiếu API Key",
        content: "Vui lòng thiết lập API Key.",
        type: "error",
      });
      setShowApiModal(true);
      return;
    ...
    if (!element || !element.name) {
      setModalMessage({
        show: true,
        title: "Thiếu Tên",
        content: "Vui lòng nhập tên thực thể trước khi tạo mô tả.",
        type: "info",
      });
      return;
    }

    setIsGeneratingInitialElementDesc((prev) => ({
      ...prev,
      [element.id]: true,
    }));
    ...
    const personalityInfo =
      element.type === "NPC" && element.personality
        ? `Tính cách NPC đã cho: ${element.personality}.`
        : "Tính cách NPC: AI tự quyết định cho phù hợp.";
  ...
  const saveApiKey = async () => {
    if (!userId) {
      setModalMessage({
        show: true,
        title: "Lỗi",
        content: "Người dùng chưa được xác thực để lưu API Key.",
        type: "error",
      });
      return;
    }
    if (!inputApiKey.trim()) {
      setModalMessage({
        ...
        content: "API Key không được để trống.",
        type: "error",
      });
      return;
    }
    ...
    try {
      const apiKeyRef = doc(
        db,
        `artifacts/${appId}/users/${userId}/apiCredentials/gemini`,
      );
      ...
      setApiKeyStatus({
        status: "Đã lưu",
        message: "API Key của bạn đã được lưu thành công!",
        color: "text-green-500",
      });
      setShowApiModal(false);
      setModalMessage({
        show: true,
        title: "Thành Công",
        content: "API Key của bạn đã được lưu!",
        type: "success",
      });
    } catch (error) {
      ...
      setApiKeyStatus({
        status: "Lỗi",
        message: `Lưu API Key thất bại: ${error.message}`,
        color: "text-red-500",
      });
      setModalMessage({
        show: true,
        title: "Lỗi Lưu API Key",
        content: `Lưu API Key thất bại: ${error.message}`,
        type: "error",
      });
    }
    setIsLoading(false);
  ...
  const loadApiKey = async (currentUserId) => {
    ...
    try {
      const apiKeyRef = doc(
        db,
        `artifacts/${appId}/users/${currentUserId}/apiCredentials/gemini`,
      );
      ...
      setModalMessage({
        show: true,
        title: "Lỗi Tải API Key",
        content: `Không thể tải API Key đã lưu: ${error.message}`,
        type: "error",
      });
      return null;
    }
  ...
  const testApiKey = async () => {
    if (!inputApiKey) {
      ...
      setModalMessage({
        show: true,
        title: "Thiếu Thông Tin",
        content: "Vui lòng nhập API Key để kiểm tra.",
        type: "info",
      });
      return;
    }
    ...
    const payload = {
      contents: [
        {
          role: "user",
          parts: [{ text: "Xin chào! Đây là một bài kiểm tra kết nối." }],
        },
      ],
    };
    const apiUrl = `https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:generateContent?key=${inputApiKey}`;
    ...
    try {
      ...
      if (response.ok && result.candidates && result.candidates.length > 0) {
        setApiKeyStatus({
          status: "Thành công (Key đang nhập)",
        ...
        setModalMessage({
          ...
          content: "API Key bạn vừa nhập hợp lệ!",
          type: "success",
        });
      } else {
        const errorMessage =
          result.error?.message ||
          `Mã lỗi ${response.status}. Vui lòng kiểm tra API Key và quyền truy cập.`;
        setApiKeyStatus({
          status: "Thất bại (Key đang nhập)",
          message: `Kiểm tra API Key thất bại: ${errorMessage}`,
          color: "text-red-500",
        });
        setModalMessage({
          show: true,
          title: "Kiểm Tra Thất Bại",
          content: `Chi tiết: ${errorMessage}`,
          type: "error",
        });
      }
    } catch (error) {
      ...
      setApiKeyStatus({
        status: "Lỗi Mạng (Key đang nhập)",
        message: `Lỗi kết nối: ${error.message}. Vui lòng kiểm tra mạng của bạn.`,
        color: "text-red-500",
      });
      setModalMessage({
        show: true,
        title: "Lỗi Kết Nối",
        content: `Không thể kết nối đến API: ${error.message}`,
        type: "error",
      });
    }
    setIsLoading(false);
  ...
  const fetchGenericGeminiText = async (promptText) => {
    ...
    if (!effectiveApiKey) {
      setModalMessage({
        ...
        title: "Lỗi API Key",
        content:
          "API Key của bạn chưa được cấu hình. Vui lòng vào Thiết Lập API.",
        type: "error",
      });
      setShowApiModal(true);
      return null;
    ...
    const apiUrl = `https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:generateContent?key=${effectiveApiKey}`;
    ...
    try {
      ...
      if (result.candidates && result.candidates[0]?.content?.parts[0]?.text) {
        ...
        const errorMsg =
          result.error?.message || "Không thể lấy dữ liệu từ AI.";
        console.error(
      ...
      setModalMessage({
        show: true,
        title: "Lỗi Mạng",
        content: `Lỗi kết nối khi gọi AI: ${error.message}`,
        type: "error",
      });
      return null;
    }
  ...
  const handleFetchSuggestions = async (fieldType) => {
    if (apiMode === "userKey" && !apiKey) {
      setModalMessage({
        show: true,
        title: "Thiếu API Key",
        content: "Vui lòng thiết lập API Key để sử dụng tính năng này.",
        type: "error",
      });
      setShowApiModal(true);
      return;
    ...
    setShowSuggestionsModal({
      ...
      suggestions: [],
      isLoading: true,
      title: fieldType === "theme" ? "✨ Gợi Ý Chủ Đề" : "✨ Gợi Ý Bối Cảnh",
    });

    let promptText = "";
    if (fieldType === "theme") {
      promptText =
        "Hãy gợi ý 10 chủ đề độc đáo và hấp dẫn bằng tiếng Việt cho một trò chơi phiêu lưu bằng văn bản (text adventure game) theo phong cách tiểu thuyết mạng Trung Quốc. Mỗi chủ đề trên một dòng, không cần đánh số đầu dòng.";
  ...
  const handleGenerateBackstory = async () => {
    ...
    const personalityInfo =
      characterPersonality && characterPersonality !== PLAYER_PERSONALITIES[0]
        ? `Tính cách: ${characterPersonality}.`
        : "Tính cách sẽ do người chơi chọn sau.";
    const promptText = `Dựa vào các thông tin sau: Tên nhân vật='${characterName || "Nhân vật chính"}', Giới tính='${characterGender}', ${personalityInfo} Chủ đề game='${theme || "Chưa rõ"}', Bối cảnh game='${setting || "Chưa rõ"}', hãy ✨ viết một đoạn sơ lược tiểu sử hoặc đặc điểm nổi bật (khoảng 2-3 câu, tối đa 150 chữ) bằng tiếng Việt cho nhân vật này để sử dụng trong một trò chơi phiêu lưu bằng văn bản, theo văn phong tiểu thuyết mạng Trung Quốc. Tiểu sử nên phản ánh tính cách đã chọn (nếu có). Chỉ trả về nội dung tiểu sử, không thêm bất kỳ lời giải thích nào.`;

    const backstoryText = await fetchGenericGeminiText(promptText);
    if (backstoryText) {
      setGameSettings((prev) => ({
        ...prev,
        characterBackstory: backstoryText,
      }));
    }
  ...
  const handleGenerateGoal = async () => {
    ...
    const { theme, setting, characterPersonality, characterBackstory } =
      gameSettings;
    const personalityInfo =
      characterPersonality && characterPersonality !== PLAYER_PERSONALITIES[0]
        ? `Tính cách nhân vật: ${characterPersonality}.`
        : "";
    const backstoryInfo = characterBackstory
      ? `Tiểu sử nhân vật: ${characterBackstory}.`
      : "";
    ...
    const generatedText = await fetchGenericGeminiText(promptText);
    if (generatedText) {
      const suggestionsArray = generatedText
        .split("\n")
        .map((s) => s.trim())
        .filter((s) => s);
      setShowSuggestionsModal({
      ...
      setModalMessage({
        ...
        content:
          "AI không thể tạo gợi ý mục tiêu lúc này. Hãy thử lại hoặc tự điền.",
        type: "info",
      });
    }
  ...
  const handleGenerateCharacterName = async () => {
    ...
    const genderPrompt =
      characterGender === "Không xác định"
        ? "phi giới tính hoặc để AI tự quyết"
        : characterGender;
    ...
    if (generatedName) {
      setGameSettings((prev) => ({
        ...prev,
        characterName: generatedName.split("\n")[0].trim(),
      }));
    }
  ...
  const handleGenerateInitialSkill = async () => {
    ...
    if (generatedSkill) {
      setGameSettings((prev) => ({
        ...prev,
        preferredInitialSkill: generatedSkill.split("\n")[0].trim(),
      }));
    }
  ...
  const handleGenerateSuggestedActions = async () => {
    ...
    const lastStoryItem =
      storyHistory.filter((item) => item.type === "story").pop()?.content ||
      "Chưa có diễn biến.";
    const inventoryString =
      knowledgeBase.inventory
        .map((item) => `${item.Name} (${item.Description || "không rõ"})`)
        .join(", ") || "trống";
    const skillsString =
      knowledgeBase.playerSkills
        .map((skill) => `${skill.Name} (${skill.Description || "không rõ"})`)
        .join(", ") || "chưa có";
    const statusesString =
      knowledgeBase.playerStatus
        .map(
          (status) =>
            `${status.name} (Ảnh hưởng: ${status.effects || "không rõ"})`,
        )
        .join("; ") || "không có";
    const currentPersonality = gameSettings.characterPersonality;
    const activeQuestsString =
      knowledgeBase.quests
        .filter((q) => q.status === "active")
        .map(
          (q) =>
            `${q.title} (Mục tiêu: ${
              q.objectives
                ...
                .map((o) => o.text)
                .join(", ") || "Hoàn thành các bước tiếp theo"
            })`,
        )
        .join("; ") || "không có";
    ...
    if (suggestionsText) {
      ...
      setModalMessage({
        show: true,
        title: "Không có gợi ý",
        content: "AI không thể tạo gợi ý hành động lúc này.",
        type: "info",
      });
    }
  ...
  const parseGeminiResponseAndUpdateState = (text) => {
    ...
    const tagPatterns = {
      ...
      STATUS_CURED_NPC:
        /\[STATUS_CURED_NPC:\s*NPCName="([^"]+)",\s*StatusName="([^"]+)"\]/gs,
      STATUS_EXPIRED_NPC:
        /\[STATUS_EXPIRED_NPC:\s*NPCName="([^"]+)",\s*StatusName="([^"]+)"\]/gs,
    ...
    const categoryMap = {
      ...
      ITEM_AQUIRED: "inventory",
      SKILL_LEARNED: "playerSkills",
      RELATIONSHIP_CHANGED: "relationships",
      ITEM_CONSUMED: "inventory",
      ITEM_UPDATED: "inventory",
      STATUS_APPLIED_SELF: "playerStatus",
      ...
      while ((match = regex.exec(processedContent)) !== null) {
        ...
        try {
          if (tagType === "GAME_OVER") {
            ...
            newKnowledgeUpdates._isGameOver = {
              isDead: true,
              reason: parsed.Reason || parsed.reason || "Không rõ lý do",
            };
            continue;
          }
          if (
            tagType === "STATUS_CURED_SELF" ||
            tagType === "STATUS_EXPIRED_SELF"
          ) {
            ...
            tagType === "STATUS_CURED_NPC" ||
            tagType === "STATUS_EXPIRED_NPC"
          ) {
            newKnowledgeUpdates._updateNpcStatus.push({
              npcName: match[1],
            ...
            if (
              ...
              if (tagType === "ITEM_CONSUMED") {
                if (!newKnowledgeUpdates._toRemove)
                  newKnowledgeUpdates._toRemove = [];
                newKnowledgeUpdates._toRemove.push({
                ...
                if (!newKnowledgeUpdates[categoryKey])
                  newKnowledgeUpdates[categoryKey] = [];
    ...
    setKnowledgeBase((prev) => {
      ...
      for (const categoryKey in newKnowledgeUpdates) {
        ...
        if (
          newKnowledgeUpdates[categoryKey] &&
          newKnowledgeUpdates[categoryKey].length > 0
        ) {
          if (!updatedKnowledge[categoryKey])
            updatedKnowledge[categoryKey] = [];

          newKnowledgeUpdates[categoryKey].forEach((newItem) => {
            const uniqueKey =
              newItem.Name || newItem.NPC || newItem.name || newItem.title;
            const existingIndex = updatedKnowledge[categoryKey].findIndex(
              (existingItem) =>
                (existingItem.Name &&
                  existingItem.Name.trim().toLowerCase() ===
                    uniqueKey.trim().toLowerCase()) ||
                (existingItem.NPC &&
                  existingItem.NPC.trim().toLowerCase() ===
                    uniqueKey.trim().toLowerCase()) ||
                (existingItem.name &&
                  existingItem.name.trim().toLowerCase() ===
                    uniqueKey.trim().toLowerCase()) ||
                (existingItem.title &&
                  existingItem.title.trim().toLowerCase() ===
                    uniqueKey.trim().toLowerCase()),
            );
            if (existingIndex > -1) {
              updatedKnowledge[categoryKey][existingIndex] = {
                ...updatedKnowledge[categoryKey][existingIndex],
                ...newItem,
              };
            } else {
      ...
      if (newKnowledgeUpdates._toUpdate) {
        newKnowledgeUpdates._toUpdate.forEach((updateInstruction) => {
          ...
          if (updatedKnowledge[category]) {
            const itemIndex = updatedKnowledge[category].findIndex(
              (item) => item.Name === data.Name,
            );
            if (itemIndex > -1) {
              updatedKnowledge[category][itemIndex] = {
                ...updatedKnowledge[category][itemIndex],
                ...data,
              };
              if (
                updatedKnowledge[category][itemIndex].Consumable &&
                typeof updatedKnowledge[category][itemIndex].Uses ===
                  "number" &&
      ...
      if (newKnowledgeUpdates._toRemove) {
        newKnowledgeUpdates._toRemove.forEach((removalInstruction) => {
          ...
          if (updatedKnowledge[category]) {
            updatedKnowledge[category] = updatedKnowledge[category].filter(
              (item) => item.Name !== name,
            );
          }
        });
      ...
      if (newKnowledgeUpdates._removePlayerStatusByName.length > 0) {
        updatedKnowledge.playerStatus = updatedKnowledge.playerStatus.filter(
          (status) =>
            !newKnowledgeUpdates._removePlayerStatusByName.includes(
              status.name,
            ),
        );
      }
      ...
      if (newKnowledgeUpdates._updateNpcStatus.length > 0) {
        newKnowledgeUpdates._updateNpcStatus.forEach((update) => {
          const npcIndex = updatedKnowledge.npcs.findIndex(
            (npc) => npc.Name === update.npcName,
          );
          if (npcIndex > -1) {
            ...
            if (update.status) {
              const existingStatusIndex = updatedKnowledge.npcs[
                npcIndex
              ].statuses.findIndex((s) => s.name === update.status.name);
              if (existingStatusIndex > -1) {
                updatedKnowledge.npcs[npcIndex].statuses[existingStatusIndex] =
                  {
                    ...updatedKnowledge.npcs[npcIndex].statuses[
                      existingStatusIndex
                    ],
              ...
              updatedKnowledge.npcs[npcIndex].statuses = updatedKnowledge.npcs[
                npcIndex
              ].statuses.filter((s) => s.name !== update.removeStatusName);
            }
          }
        });
      }
      ...
      if (newKnowledgeUpdates._updateQuest.length > 0) {
        newKnowledgeUpdates._updateQuest.forEach((questUpdateData) => {
          const questIndex = updatedKnowledge.quests.findIndex(
            (q) => q.title === questUpdateData.title,
          );
          if (questIndex > -1) {
            updatedKnowledge.quests[questIndex] = {
              ...updatedKnowledge.quests[questIndex],
              ...questUpdateData,
            };
            if (
              questUpdateData.objectiveCompleted &&
              updatedKnowledge.quests[questIndex].objectives
            ) {
              const objIndex = updatedKnowledge.quests[
                questIndex
              ].objectives.findIndex(
                (obj) => obj.text === questUpdateData.objectiveCompleted,
              );
              if (objIndex > -1) {
                updatedKnowledge.quests[questIndex].objectives[
                  objIndex
      ...
      if (newKnowledgeUpdates._updateQuestObjective.length > 0) {
        newKnowledgeUpdates._updateQuestObjective.forEach((objUpdateData) => {
          const questIndex = updatedKnowledge.quests.findIndex(
            (q) => q.title === objUpdateData.questTitle,
          );
          if (
            questIndex > -1 &&
            updatedKnowledge.quests[questIndex].objectives
            ...
            const objIndex = updatedKnowledge.quests[
              ...
              (obj) => obj.text === objUpdateData.objectiveDescription,
            );
            if (objIndex > -1) {
              updatedKnowledge.quests[questIndex].objectives[
                objIndex
    ...
    return {
      ...
      gameOver: newKnowledgeUpdates._isGameOver,
    };
  };
  ...
  const callGeminiAPI = async (
    ...
    if (currentChatHistory.length > MAX_HISTORY_LENGTH) {
      const systemPromptIndex = currentChatHistory.findIndex(
        (msg) => msg.role === "system",
      );
      const historyToKeep = currentChatHistory.slice(
        currentChatHistory.length - MAX_HISTORY_LENGTH,
      );
      if (
        systemPromptIndex !== -1 &&
        systemPromptIndex < currentChatHistory.length - MAX_HISTORY_LENGTH
      ) {
        currentChatHistory = [
          currentChatHistory[systemPromptIndex],
          ...historyToKeep,
        ];
      } else {
    ...
    try {
      ...
      if (
        ...
        } = parseGeminiResponseAndUpdateState(rawText);
        if (newGameOver) {
        ...
        if (result.error) {
          ...
          if (
            ...
            result.error.message.toLowerCase().includes("api key not valid")
          ) {
  ...
  const initializeGame = async () => {
    if (
      ...
      setModalMessage({
        ...
        title: "Thiếu Thông Tin",
        content:
          "Vui lòng điền đầy đủ thông tin Chủ đề, Bối cảnh, Tên nhân vật và Sơ lược tiểu sử.",
        type: "error",
      });
      return;
    }
    if (
      ...
      setModalMessage({
        show: true,
        title: "Thiếu Mô Tả Độ Khó",
        content: 'Vui lòng tạo hoặc nhập mô tả cho độ khó "Tuỳ Chỉnh AI".',
        type: "error",
      });
      return;
    }
    if (gameSettings.useCharacterGoal && !gameSettings.characterGoal) {
      setModalMessage({
        ...
        content: "Vui lòng điền mục tiêu cho nhân vật hoặc tắt tùy chọn này.",
        type: "error",
      });
      return;
    }
    if (apiMode === "userKey" && !apiKey) {
      setModalMessage({
        ...
        title: "Thiếu API Key",
        content:
          "Vui lòng thiết lập API Key của bạn hoặc chọn chế độ AI mặc định.",
        type: "error",
      });
      setShowApiModal(true);
      return;
    ...
    const initialWorldElementsString = gameSettings.initialWorldElements
      .map(
        (el) =>
          `- Loại: ${el.type}, Tên: ${el.name}, Mô tả: ${el.description}${el.type === "NPC" && el.personality ? `, Tính cách NPC đã cho: ${el.personality}` : ""}`,
      )
      .join("\n");
    ...
    const characterGoalInstruction =
      gameSettings.useCharacterGoal && gameSettings.characterGoal
    ...
    const initialPrompt = `
        ...
        --- HỆ THỐNG THẺ BẮT BUỘC (PHẢI ĐÚNG ĐỊNH DẠNG) ---
        QUY TẮC ĐẶC BIỆT: Bạn PHẢI sử dụng các THẺ (TAGS) dưới đây để cập nhật trạng thái hệ thống. Các thẻ này phải nằm ở dòng riêng biệt.
        1. THẾ GIỚI & NHÂN VẬT (LORE):
           - [LORE_NPC: Name="Tên", Description="Mô tả ngoại hình/vai trò", Personality="Tính cách"]
           - [LORE_ITEM: Name="Tên", Description="Mô tả vật phẩm", Type="Loại (Vũ khí/Pháp bảo/Dược phẩm)"]
           - [LORE_LOCATION: Name="Tên", Description="Mô tả địa danh"]
           - [COMPANION: Name="Tên Đồng Hành", Description="Mô tả", Personality="AI tự quyết định", Stats="HP=Y, ATK=Z (nếu có)"]
        2. TRẠNG THÁI NHÂN VẬT CHÍNH (SELF):
           - Nhận trạng thái: [STATUS_APPLIED_SELF: name="Tên Trạng Thái", description="Mô tả", type="buff/debuff/injury/neutral", duration="X lượt/Vĩnh viễn/Đến khi được chữa/Tự hết sau X sự kiện", effects="Ảnh hưởng cụ thể", cureConditions="Vật phẩm:Tên/Hành động:Tên/Tự hết/Không thể chữa", source="Nguồn gốc"]
           - Hết trạng thái: [STATUS_CURED_SELF: Name="Tên Trạng Thái"] hoặc [STATUS_EXPIRED_SELF: Name="Tên Trạng Thái"]
        3. TRẠNG THÁI NPC:
           - Nhận trạng thái: [STATUS_APPLIED_NPC: NPCName="Tên NPC", name="Tên Trạng Thái", description="...", type="...", duration="...", effects="...", cureConditions="...", source="..."]
           - Hết trạng thái: [STATUS_CURED_NPC: NPCName="Tên NPC", StatusName="Tên Trạng Thái"] hoặc [STATUS_EXPIRED_NPC: NPCName="Tên NPC", StatusName="Tên Trạng Thái"]
        4. HÀNH TRANG & KỸ NĂNG:
           - Nhận vật phẩm: [ITEM_AQUIRED: Name="Tên Vật Phẩm", Description="Mô tả", Type="Loại", Equippable=true/false, Usable=true/false, Consumable=true/false, Uses=X (nếu có giới hạn)]
           - Tiêu hao/Mất vật phẩm: [ITEM_CONSUMED: Name="Tên Vật Phẩm"]
           - Cập nhật số lượng/độ bền: [ITEM_UPDATED: Name="Tên Vật Phẩm", Uses=X (số lần còn lại)]
           - Học kỹ năng: [SKILL_LEARNED: Name="Tên Kỹ Năng", Description="Mô tả", Type="Loại Kỹ Năng"]
        5. QUAN HỆ & NHIỆM VỤ:
           - Quan hệ: [RELATIONSHIP_CHANGED: NPC="Tên NPC", Standing="Thân thiện/Thù địch/Kính trọng", Reason="Lý do"]
           - Giao nhiệm vụ: [QUEST_ASSIGNED: title="Tên Nhiệm Vụ", description="Mô tả chi tiết", objectives="Mục tiêu 1; Mục tiêu 2 (nếu có, cách nhau bởi dấu ';')", giver="Tên NPC giao (nếu có)", reward="Mô tả phần thưởng (nếu có)", isMainQuest=true/false]
           - Cập nhật nhiệm vụ: [QUEST_UPDATED: title="Tên Nhiệm Vụ", status="completed/failed"]
           - Hoàn thành mục tiêu nhỏ: [QUEST_OBJECTIVE_COMPLETED: questTitle="Tên Nhiệm Vụ", objectiveDescription="Mô tả mục tiêu vừa hoàn thành"]
        6. KẾT THÚC (Dùng khi nhân vật chết hoặc đạt kết thúc):
           - [GAME_OVER: Reason="Mô tả chi tiết lý do cái chết hoặc kết thúc hành trình"]

        --- QUY TẮC VIẾT THẺ ---
            - Mỗi thẻ PHẢI nằm trên một dòng riêng.
            - Các thuộc tính bên trong thẻ PHẢI có định dạng Key="Value" (Dùng dấu ngoặc kép cho giá trị là chuỗi).
            - KHÔNG tự ý thêm bớt tên thuộc tính để tránh lỗi Parse.
            - Ngay sau khi dùng [QUEST_UPDATED: status="completed"], phải dùng tiếp thẻ [ITEM_AQUIRED] hoặc [SKILL_LEARNED] nếu nhiệm vụ đó có phần thưởng thực thể.
        ...
        10. Khi giới thiệu NPC, Vật phẩm (lore), Địa điểm mới, dùng [LORE_NPC: Name="Tên", Description="Mô tả ngoại hình/vai trò", Personality="Tính cách (AI tự quyết nếu chưa có)"], [LORE_ITEM: Name="Tên", Description="Mô tả vật phẩm", Type="Loại (Vũ khí/Pháp bảo/Dược phẩm)"], [LORE_LOCATION: Name="Tên", Description="Mô tả địa danh"].
        11. Khi nhân vật nhận vật phẩm vào balo, dùng [ITEM_AQUIRED: Name="Tên Vật Phẩm", Description="Mô tả", Type="Loại", Equippable=true/false, Usable=true/false, Consumable=true/false, Uses=X (nếu có giới hạn)].
        12. Khi nhân vật học kỹ năng mới, dùng [SKILL_LEARNED: Name="Tên Kỹ Năng", Description="Mô tả", Type="Loại Kỹ Năng"].
        ...
        16. QUY TẮC XỬ LÝ PHẦN THƯỞNG: Ngay khi dùng thẻ [QUEST_UPDATED: title="Tên Nhiệm Vụ", status="completed"], PHẢI thực hiện các hành động sau dựa trên reward đã ghi trong thẻ [QUEST_ASSIGNED: ...]:
            - Nếu là Kỹ năng/Vật phẩm: Dùng thẻ [SKILL_LEARNED: Name="Tên Kỹ Năng", Description="Mô tả", Type="Loại Kỹ Năng"], [ITEM_AQUIRED: Name="Tên Vật Phẩm", Description="Mô tả", Type="Loại", Equippable=true/false, Usable=true/false, Consumable=true/false, Uses=X (nếu có giới hạn)]. Phải mô tả cảnh nhân vật lĩnh ngộ hoặc nhận được vật phẩm đó trong nội dung truyện.
            - Nếu là Địa điểm/Thông tin: Dùng thẻ [LORE_LOCATION: Name="Tên", Description="Mô tả địa danh"], Phải mở khóa tình tiết mới trong diễn biến, buộc phải xuất hiện ít nhất một lựa chọn dẫn đến địa điểm hoặc sử dụng thông tin đó trong các lựa chọn tiếp theo.
            - Nếu là Chỉ số/Trạng thái: Dùng thẻ [STATUS_APPLIED_SELF: name="Tên Trạng Thái", description="Mô tả", type="buff/debuff/injury/neutral", duration="X lượt/Vĩnh viễn/Đến khi được chữa/Tự hết sau X sự kiện", effects="Ảnh hưởng cụ thể", cureConditions="Vật phẩm:Tên/Hành động:Tên/Tự hết/Không thể chữa", source="Nguồn gốc"] để phản ánh sự thay đổi sức mạnh hoặc danh tiếng của người chơi ngay lập tức.
            - Nguyên tắc: Phần thưởng không được là "hứa suông", AI phải coi phần thưởng là một biến số thực thể ảnh hưởng trực tiếp đến logic của chương tiếp theo.
        
        --- QUY TẮC HỆ THỐNG XÚC XẮC (DICE SYSTEM) ---
        AI đóng vai trò Game Master. Khi người chơi chọn một hành động có rủi ro, AI phải thực hiện "tung xúc xắc ngầm" dựa trên các ngưỡng sau:
        1. ĐỊNH NGHĨA TỶ LỆ THÀNH CÔNG (SUCCESS RATE):
           - [Rất Cao]: 85% - 100% (Gần như chắc chắn)
           - [Cao]: 65% - 85% (Có lợi thế lớn)
           - [Trung Bình]: 40% - 65% (Cân bằng, may rủi)
           - [Thấp]: 15% - 40% (Nguy hiểm, cần kỹ năng bổ trợ)
           - [Rất Thấp]: 0% - 15% (Cực kỳ mong manh)
        2. CƠ CHẾ QUYẾT ĐỊNH KẾT QUẢ THEO ĐỘ KHÓ:
           Dựa vào độ khó "${gameSettings.difficulty}" đã chọn:
           - Nếu ĐỘ KHÓ LÀ [Dễ]:
             + Thất bại (ngay cả ở tỷ lệ Thấp) KHÔNG dẫn đến cái chết.
             + Hậu quả: Nhân vật bị thương (dùng thẻ [STATUS_APPLIED_SELF: name="Tên Trạng Thái", description="Mô tả", type="buff/debuff/injury/neutral", duration="X lượt/Vĩnh viễn/Đến khi được chữa/Tự hết sau X sự kiện", effects="Ảnh hưởng cụ thể", cureConditions="Vật phẩm:Tên/Hành động:Tên/Tự hết/Không thể chữa", source="Nguồn gốc"]), mất vật phẩm (dùng thẻ [ITEM_CONSUMED: Name="Tên Vật Phẩm"]), hoặc bị NPC ghét bỏ. Câu chuyện PHẢI tiếp tục.
           - Nếu ĐỘ KHÓ LÀ [Thường] hoặc [Khó]:
             + AI tung xúc xắc nghiêm ngặt hơn.
             + Thất bại ở hành động [Rất Thấp] hoặc [Thấp] có thể dẫn đến trọng thương hoặc rơi vào tình huống ngặt nghèo khó thoát.
           - Nếu ĐỘ KHÓ LÀ [ÁC MỘNG]:
             + Mọi hành động có tỷ lệ thành công [Thấp] hoặc [Rất Thấp] đều dẫn đến CÁI CHẾT ngay lập tức.
             + AI PHẢI cho nhân vật thất bại thảm hại, Tuyệt đối không được "cứu" nhân vật bằng những tình tiết phi logic.
           - Khi cái chết xảy ra, hãy viết một đoạn kết bi thảm, sau đó dùng thẻ [GAME_OVER: Reason="Mô tả chi tiết lý do cái chết hoặc kết thúc hành trình"] và không đưa ra thêm bất kỳ lựa chọn nào nữa.
        3. QUY TẮC HIỂN THỊ LỰA CHỌN:
           - Tạo 4-5 lựa chọn hành động rõ ràng, có ý nghĩa, đa dạng. Các lựa chọn phải phản ánh tính cách và mục tiêu của nhân vật, cũng như tình hình thực tế, các trạng thái và nhiệm vụ hiện tại.
           - Với các lựa chọn rủi ro, hãy mô tả: (Tỷ lệ thành công: Rất Cao/Cao/Trung Bình/Thấp/Rất Thấp. Rủi ro: ... Phần thưởng: ... Hậu quả: ...). Tỷ lệ này phải bị ảnh hưởng bởi trạng thái, tính cách, trang bị, vật phẩm, kỹ năng của nhân vật và tình huống. Ví dụ: "1. Thử leo vách đá. (Tỷ lệ thành công: Thấp - Do ngươi đang [Bị Thương]. Rủi ro: Ngã nặng hơn. Phần thưởng: Tìm được lối tắt.)"
    ...
    if (userId && isAuthReady) {
      try {
        ...
        setModalMessage({
          show: true,
          title: "Lỗi Tạo Game",
          content: `Không thể tạo game mới trên server: ${error.message}`,
          type: "error",
        });
  ...
  const handleChoice = (choiceText) => {
    ...
    const characterGoal =
      gameSettings.useCharacterGoal && gameSettings.characterGoal
        ? gameSettings.characterGoal
        : "Chưa có hoặc không rõ";
    const playerStatusesString =
      knowledgeBase.playerStatus
        .map((s) => `${s.name} (Ảnh hưởng: ${s.effects})`)
        .join("; ") || "Không có";
    const activeQuestsSummary =
      knowledgeBase.quests
        ...
        .map(
          (q) =>
            `- ${q.title}: ${q.description.substring(0, 50)}... (Mục tiêu: ${
    ...
    const subsequentPrompt = `
        ...
        --- YÊU CẦU CỤ THỂ ---
        1.  Khi nhân vật (hoặc NPC) nhận một trạng thái mới (buff, debuff, injury), dùng thẻ:
            [STATUS_APPLIED_SELF: name="Tên Trạng Thái", description="Mô tả", type="buff/debuff/injury/neutral", duration="X lượt/Vĩnh viễn/Đến khi được chữa/Tự hết sau X sự kiện", effects="Ảnh hưởng cụ thể", cureConditions="Vật phẩm:Tên/Hành động:Tên/Tự hết/Không thể chữa", source="Nguồn gốc"]
            [STATUS_APPLIED_NPC: NPCName="Tên NPC", name="Tên Trạng Thái", description="...", type="...", duration="...", effects="...", cureConditions="...", source="..."]
        2.  Khi trạng thái của nhân vật chính được chữa khỏi hoặc hết hạn, dùng: [STATUS_CURED_SELF: Name="Tên Trạng Thái"] hoặc [STATUS_EXPIRED_SELF: Name="Tên Trạng Thái"].
        3.  Khi trạng thái của NPC được chữa khỏi hoặc hết hạn, dùng: [STATUS_CURED_NPC: NPCName="Tên NPC", StatusName="Tên Trạng Thái"] hoặc [STATUS_EXPIRED_NPC: NPCName="Tên NPC", StatusName="Tên Trạng Thái"].
        4.  Các trạng thái PHẢI có ảnh hưởng thực tế đến câu chuyện, lựa chọn, hoặc khả năng của nhân vật/NPC.
        5.  Nếu có "Kỹ năng khởi đầu mong muốn", hãy tạo một kỹ năng phù hợp và thông báo bằng thẻ [SKILL_LEARNED: Name="Tên Kỹ Năng", Description="Mô tả", Type="Loại Kỹ Năng"]. Nếu không, tự tạo một kỹ năng ban đầu phù hợp.
        ...
        7.  Nếu nhân vật bắt đầu với vật phẩm trong balo, sử dụng thẻ [ITEM_AQUIRED: Name="Tên Vật Phẩm", Description="Mô tả", Type="Loại", Equippable=true/false, Usable=true/false, Consumable=true/false, Uses=X (nếu có giới hạn)].
        8.  Nếu nhân vật bắt đầu với đồng hành, sử dụng thẻ [COMPANION: Name="Tên Đồng Hành", Description="Mô tả", Personality="AI tự quyết định", Stats="HP=Y, ATK=Z (nếu có)"].
        9. Khi giới thiệu NPC, Vật phẩm (lore), Địa điểm mới, dùng [LORE_NPC: Name="Tên", Description="Mô tả ngoại hình/vai trò", Personality="Tính cách (AI tự quyết nếu chưa có)"], [LORE_ITEM: Name="Tên", Description="Mô tả vật phẩm", Type="Loại (Vũ khí/Pháp bảo/Dược phẩm)"], [LORE_LOCATION: Name="Tên", Description="Mô tả địa danh"].
        10. Khi nhân vật nhận vật phẩm vào balo, dùng [ITEM_AQUIRED: Name="Tên Vật Phẩm", Description="Mô tả", Type="Loại", Equippable=true/false, Usable=true/false, Consumable=true/false, Uses=X (nếu có giới hạn)].
        11. Khi nhân vật học kỹ năng mới, dùng [SKILL_LEARNED: Name="Tên Kỹ Năng", Description="Mô tả", Type="Loại Kỹ Năng"].
        12. Khi mối quan hệ thay đổi, dùng [RELATIONSHIP_CHANGED: NPC="Tên NPC", Standing="Thân thiện/Trung lập/Thù địch/etc.", Reason="Lý do thay đổi (ngắn gọn)"].
        13. Khi vật phẩm được sử dụng và tiêu hao hoàn toàn, dùng thẻ [ITEM_CONSUMED: Name="Tên Vật Phẩm"]. Nếu chỉ giảm số lần dùng, dùng [ITEM_UPDATED: Name="Tên Vật Phẩm", Uses=X (số lần còn lại)].
        14. HỆ THỐNG NHIỆM VỤ:
            - AI có thể giao nhiệm vụ cho người chơi. Dùng thẻ: [QUEST_ASSIGNED: title="Tên Nhiệm Vụ", description="Mô tả chi tiết", objectives="Mục tiêu 1; Mục tiêu 2 (nếu có, cách nhau bởi dấu ';')", giver="Tên NPC giao (nếu có)", reward="Mô tả phần thưởng (nếu có)", isMainQuest=true/false]
            - Khi một nhiệm vụ được cập nhật (hoàn thành, thất bại), dùng thẻ: [QUEST_UPDATED: title="Tên Nhiệm Vụ", status="completed/failed"]
            - Khi một mục tiêu cụ thể của nhiệm vụ được hoàn thành (nhưng nhiệm vụ chưa kết thúc), dùng thẻ: [QUEST_OBJECTIVE_COMPLETED: questTitle="Tên Nhiệm Vụ", objectiveDescription="Mô tả mục tiêu vừa hoàn thành"]
            - Nhiệm vụ PHẢI ảnh hưởng đến diễn biến câu chuyện và lựa chọn của người chơi.
        15. QUY TẮC XỬ LÝ PHẦN THƯỞNG: Ngay khi dùng thẻ [QUEST_UPDATED: title="Tên Nhiệm Vụ", status="completed"], PHẢI thực hiện các hành động sau dựa trên reward đã ghi trong thẻ [QUEST_ASSIGNED: ...]:
            - Nếu là Kỹ năng/Vật phẩm: Dùng thẻ [SKILL_LEARNED: Name="Tên Kỹ Năng", Description="Mô tả", Type="Loại Kỹ Năng"], [ITEM_AQUIRED: Name="Tên Vật Phẩm", Description="Mô tả", Type="Loại", Equippable=true/false, Usable=true/false, Consumable=true/false, Uses=X (nếu có giới hạn)]. Phải mô tả cảnh nhân vật lĩnh ngộ hoặc nhận được vật phẩm đó trong nội dung truyện.
            - Nếu là Địa điểm/Thông tin: Dùng thẻ [LORE_LOCATION: Name="Tên", Description="Mô tả địa danh"], Phải mở khóa tình tiết mới trong diễn biến, buộc phải xuất hiện ít nhất một lựa chọn dẫn đến địa điểm hoặc sử dụng thông tin đó trong các lựa chọn tiếp theo.
            - Nếu là Chỉ số/Trạng thái: Dùng thẻ [STATUS_APPLIED_SELF: name="Tên Trạng Thái", description="Mô tả", type="buff/debuff/injury/neutral", duration="X lượt/Vĩnh viễn/Đến khi được chữa/Tự hết sau X sự kiện", effects="Ảnh hưởng cụ thể", cureConditions="Vật phẩm:Tên/Hành động:Tên/Tự hết/Không thể chữa", source="Nguồn gốc"] để phản ánh sự thay đổi sức mạnh hoặc danh tiếng của người chơi ngay lập tức.
            - Nguyên tắc: Phần thưởng không được là "hứa suông", AI phải coi phần thưởng là một biến số thực thể ảnh hưởng trực tiếp đến logic của chương tiếp theo.
  ...
  const handleCustomAction = (actionText) => {
    if (!actionText.trim()) {
      setModalMessage({
        show: true,
        title: "Hành Động Trống",
        content: "Vui lòng nhập hành động của ngươi.",
        type: "info",
      });
      return;
    }
  ...
  const saveGameProgress = async (
    ...
    if (!userId || !gameIdToSave || !isAuthReady) {
      console.log(
        "Không thể lưu game: User ID/Game ID không tồn tại hoặc auth chưa sẵn sàng.",
      );
      return;
    }
    try {
  ...
  const loadGame = async (gameData) => {
    ...
    const currentGameOverStatus = gameData.gameOver || {
      isDead: false,
      reason: "",
    };
    setGameOver(currentGameOverStatus);

    setGameSettings({ ...defaultSettings, ...(gameData.settings || {}) });
    setCurrentStory(gameData.currentStory || "");

    if (currentGameOverStatus.isDead) {
      setChoices([]);
    } else {
    ...
    if (apiMode === "userKey" && !apiKey && userId) {
      ...
      if (userApiKey) {
        ...
        setModalMessage({
          show: true,
          title: "Cần API Key",
          content: "Vui lòng cấu hình API Key của bạn để tiếp tục tải game.",
          type: "info",
        });
        return;
      }
  ...
  const restartGame = () => {
    setConfirmationModal({
      ...
      content:
        "Ngươi có muốn lưu tiến trình hiện tại trước khi bắt đầu lại không?",
      onConfirm: async () => {
        if (currentGameId && currentStory && storyHistory.length > 0) {
          ...
          setModalMessage({
            show: true,
            title: "Đã Lưu",
            content: "Tiến trình game hiện tại đã được lưu.",
            type: "success",
          });
        }
        performRestart();
  ...
  const goHome = () => {
    if (
      ...
      setConfirmationModal({
        ...
        title: "Về Trang Chủ?",
        content:
          "Ngươi có muốn lưu tiến trình game hiện tại trước khi về trang chủ không?",
        onConfirm: async () => {
          await saveGameProgress(
            currentGameId,
            currentStory,
          ...
          setModalMessage({
            show: true,
            title: "Đã Lưu",
            content: "Tiến trình game đã được lưu.",
            type: "success",
          });
          setCurrentScreen("initial");
        },
  ...
  // Tách lựa chọn cuối
  const getChoicesFromHistory = (history) => {
    ...
    while ((match = regex.exec(text)) !== null) {
      ...
      if (content) choices.push(content);
    }
    return choices;
  };

  // Hàm Lưu Game ra tệp .json
  const exportGameToJson = () => {
    try {
      const extractedChoices = getChoicesFromHistory(chatHistoryForGemini);
      const rawData = {
        currentStory: currentStory || "",
        currentChoices:
          extractedChoices.length > 0 ? extractedChoices : suggestedActionsList,
        storyHistory: [...storyHistory],
        chatHistoryForGemini: [...chatHistoryForGemini],
        knowledgeBase: { ...knowledgeBase },
        settings: { ...gameSettings },
        gameOver: gameOver || { isDead: false, reason: "" },
      ...
      const fileName = `Save_${gameSettings.characterName || "User"}_${Date.now()}.json`;
      ...
      setModalMessage({
        ...
        title: "Lỗi Xuất File",
        content:
          "Trình duyệt của bạn không hỗ trợ tải file trực tiếp. Hãy thử dùng Chrome hoặc trình duyệt khác.",
        type: "error",
      });
    }
  };

  // Hàm Tải Game từ tệp .json
  const importGameFromJson = (event) => {
    ...
    reader.onload = async (e) => {
      try {
        ...
        const isDead = gameData.gameOver?.isDead || false;
        const choices = isDead ? [] : gameData.currentChoices || [];

        setChoices(choices);
        setSuggestedActionsList(choices);
        setKnowledgeBase(
          gameData.knowledgeBase || {
            npcs: [],
            items: [],
        ...
        if (userId && isAuthReady) {
          const newGameId = `Imported_${gameData.settings?.characterName || "User"}_${Date.now()}`;
          const gameDocRef = doc(
            db,
            `artifacts/${appId}/users/${userId}/games`,
            newGameId,
        ...
        const successContent = isDead
          ? `Đã khôi phục hành trình cuối cùng của ${gameData.settings?.characterName}.`
          : `Đã khôi phục hành trình của ${gameData.settings?.characterName}. Các lựa chọn hành động đã sẵn sàng!`;
        setModalMessage({
          show: true,
        ...
        setModalMessage({
          show: true,
          title: "Lỗi",
          content: "File không hợp lệ hoặc bị hỏng.",
          type: "error",
        });
      } finally {
        target.value = "";
  ...
  // Xuat story
  const exportStoryToTxt = () => {
    try {
      const skillsString = knowledgeBase.playerSkills
        .map(
          (skill) =>
            `▪ ${skill.Name}: ${skill.Description || "Không có mô tả"}`,
        )
        .join("\n");
      ...
      const fileHeader = [
        `- Tên truyện: ${gameSettings.theme || "Chưa đặt tên"}`,
        `- Bối cảnh: ${gameSettings.setting || "Chưa rõ"}`,
        `- Nhân vật chính: ${gameSettings.characterName || "Vô danh"}`,
        `- Giới thiệu nhân vật: ${gameSettings.characterBackstory || "Chưa có tiểu sử"}`,
        `- Các kỹ năng của nhân vật:\n${skillsString || "- Chưa có kỹ năng"}`,
        `\n========================================\n`,
        `NỘI DUNG CÂU CHUYỆN\n`,
        storyContent,
        `\n========================================\n`,
        `Nội dung được tạo bởi: Nhập Vai A.I Simulator - Một sản phẩm của Thanh Bình (@binhxy).`,
      ].join("\n");
      ...
      const link = document.createElement("a");
      link.href = url;
      link.download = `CauChuyen_${gameSettings.characterName || "User"}.txt`;
      document.body.appendChild(link);
      link.click();
        ...
        return segments.map((segment, index) => {
          if (segment.type === "text") {
            ...
            formattedSegment = formattedSegment.replace(
              /^([\w\s\u00C0-\u017F]+):\s*"(.*?)"/gm,
              (match, p1, p2) =>
                `<strong class="text-blue-400">${p1.trim()}:</strong> "${p2}"`,
            );
            formattedSegment = formattedSegment.replace(
              /(?<!\w)\*(.*?)\*(?!\w)/g,
              '<em class="text-purple-400 italic">"$1"</em>',
            );
            formattedSegment = formattedSegment.replace(
              /(?<!\w)_(.*?)_(?!\w)/g,
              '<em class="text-purple-400 italic">"$1"</em>',
            ...
            formattedSegment = formattedSegment.replace(
              /\[(?!PLAYER_PERSONALITY|LORE_|COMPANION|ITEM_AQUIRED|SKILL_LEARNED|RELATIONSHIP_CHANGED|ITEM_CONSUMED|ITEM_UPDATED|STATUS_APPLIED_SELF|STATUS_CURED_SELF|STATUS_EXPIRED_SELF|STATUS_APPLIED_NPC|STATUS_CURED_NPC|STATUS_EXPIRED_NPC|QUEST_ASSIGNED|QUEST_UPDATED|QUEST_OBJECTIVE_COMPLETED)(.*?)\]/g,
              '<span class="text-yellow-400 font-semibold">[$1]</span>',
            );
            formattedSegment = formattedSegment.replace(
              /\*\*(.*?)\*\*/g,
              '<strong class="text-xl block my-2 text-green-400">$1</strong>',
            );
            return (
              <span
                key={`segment-${index}`}
                dangerouslySetInnerHTML={{ __html: formattedSegment }}
              />
            );
    ...
    <div className="font-['Arial',_sans-serif] text-white">
      {currentScreen === "initial" && (
        <InitialScreen
          ...
          importGameFromJson={importGameFromJson}
      ...
      {currentScreen === "gameplay" && (
        <GameplayScreen
          ...
          exportStoryToTxt={exportStoryToTxt}
      ...
      {showDonationModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
          <div className="bg-gray-800 border border-gray-700 rounded-2xl max-w-md w-full p-6 shadow-2xl overflow-y-auto max-h-[90vh]">
            <div className="flex flex-col items-center text-center">
              {/* Icon Trái tim */}
              <div className="bg-rose-500/20 p-6 rounded-full mb-4 flex items-center justify-center w-20 h-20 mx-auto">
              ...
              <p className="text-gray-400 mb-6 text-sm">
                Sự đóng góp của bạn giúp mình duy trì và phát triển
                <br />
                Nhập Vai AI Simulator!
              </p>

              {/* MÃ QR CODE */}
              <div className="bg-white p-3 rounded-xl mb-6 shadow-lg transform transition-transform hover:scale-105">
                <img
                  src="https://img.vietqr.io/image/bidv-8847804617-compact2.jpg?accountName=NONG%20THANH%20BINH"
                  alt="Mã QR ủng hộ"
              ...
              <div className="w-full space-y-4 bg-gray-900/50 p-4 rounded-xl border border-gray-700 text-left">
                <div>
                  <label className="text-xs font-bold text-gray-500 uppercase">
                    Ngân hàng
                  </label>
                  <p className="text-white text-base font-semibold text-wrap">
                    BIDV
                  </p>
                </div>
                <div>
                  ...
                  <div className="flex items-center justify-between bg-gray-800 p-2 rounded-lg border border-gray-700 mt-1">
                    <p className="text-rose-400 text-xl font-mono font-bold tracking-wider ml-1">
                      8847804617
                    </p>
                    <button
                    ...
                    >
                      {copied ? <DonCheckIcon /> : <DonCopyIcon />}
                    </button>
                  </div>
                </div>
                <div>
      ...
      <SuggestionsModal
        ...
        onSelect={(suggestion) => {
          if (showSuggestionsModal.fieldType === "characterGoal") {
            ...
            setGameSettings((prev) => ({
              ...prev,
              [showSuggestionsModal.fieldType]: suggestion,
            }));
          }
        }}
        onClose={() =>
